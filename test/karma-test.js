...
describe("#colorParse()", function() {
	it("should parse hex colors", function() {
		var r = bw.colorParse('#ff0000');
		assert.deepEqual(r, [255, 0, 0, 255, "rgb"]);
	});
	it("should parse rgb() strings", function() {
		var r = bw.colorParse('rgb(128, 64, 32)');
		assert.deepEqual(r, [128, 64, 32, 255, "rgb"]);
	});
});

describe("#colorRgbToHsl()", function() {
	it("should convert pure green", function() {
		var r = bw.colorRgbToHsl(0, 255, 0);
		assert.deepEqual(r, [120, 100, 50, 255, "hsl"]);
	});
});

describe("#colorHslToRgb()", function() {
	it("should convert pure green", function() {
		var r = bw.colorHslToRgb(120, 100, 50, 128);
		assert.deepEqual(r, [0, 255, 0, 128, "rgb"]);
	});
});
...
.bw_tab_item{display:inline;padding-top:0.5em;padding-left:0.75em;padding-right:0.75em;border-top-right-radius:7px;border-top-left-radius:7px;}

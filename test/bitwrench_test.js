...
*/
	var tests = [
		{args: [[[1,2,3],[2,3,4]]], expected: "<table class=\"bw_table bw_table_stripe\" ><thead><tr><th>1</th><th>2</th><th>3</th></tr></thead><tbody><tr><td>2</td><td>3</td><td>4</td></tr></tbody></table>" }
	];
...
.bw_def_page_setup{height:100%;width:90%;margin:0 auto;padding-left:2%;padding-right:2%;left:0;top:1%;box-sizing:border-box;}
.bw_font_serif{font-family:Times New Roman, Times, serif;}
.bw_font_sans_serif{font-family:Arial, Helvetica, sans-serif;}

.bw_left{text-align:left;}
.bw_right{text-align:right;}
.bw_center{text-align:center;margin:0 auto;}
.bw_justify{text-align:justify;}
.bw_code{font-family:monospace;white-space:pre-wrap;}
.bw_pad1{padding-left:1%;padding-right:1%;}

.bw_table{border-collapse:collapse;border-spacing:0;border:1px solid #444;}
.bw_table th{background-color:#bbb;padding:4px;border:1px solid #444;}
.bw_table td{padding:4px;border:1px solid #444;}
.bw_table_stripe tr:nth-child(even){background-color:#f0f0f0;}
.bw_table tr td:first-child{font-weight:700;}
.bw_table_border_round{border-radius:2px;}
.bw_table_sort_upa::after{content:\"\\2191\";}
.bw_table_sort_dna::after{content:\"\\2193\";}
.bw_table_sort_xxa::after{content:\"\\00a0\";}

.bw_tab_item_list{margin:0;padding-inline-start:0;}
.bw_tab_item{display:inline;padding-top:0.75em;padding-left:0.75em;padding-right:0.75em;border-top-right-radius:7px;border-top-left-radius:7px;}
.bw_tab_active{font-weight:700;}
.bw_tab:hover{cursor:pointer;font-weight:700;}
.bw_tab_content_list{margin:0;padding-top:0.0em;}
.bw_tab_content{display:none;border-radius:0;}
.bw_tab_content, .bw_tab_active{background-color:#ddd;padding:0.5em;}

.bw_accordian_container > div{padding:0.5em;}

.bw_container{margin:0 auto;}
.bw_row{width:100%;display:block;}
.bw_row [class^=\"bw_col\"]{float:left;}
.bw_row::after{content:\"\";display:table;clear:both;}
.bw_box_1{padding-top:10px;padding-bottom:10px;border-radius:8px;}

.bw_sign{position:inherit;display:table;height:100%;width:100%;}
.bw_sign > div{display:table-cell;vertical-align:middle;}
.bw_sign > div > div{text-align:center;}

.bw_hide{display:none;}
.bw_show{display:block;}
.bw_h1{font-size:2.312rem;}
.bw_h2{font-size:1.965rem;}
.bw_h3{font-size:1.67rem;}
.bw_h4{font-size:1.419rem;}
.bw_h5{font-size:1.206rem;}
.bw_h6{font-size:1.025rem;}

.bw_col_1{width:8.333%;}
.bw_col_2{width:16.666%;}
.bw_col_3{width:25%;}
.bw_col_4{width:33.333%;}
.bw_col_5{width:41.666%;}
.bw_col_6{width:50%;}
.bw_col_7{width:58.333%;}
.bw_col_8{width:66.666%;}
.bw_col_9{width:75%;}
.bw_col_10{width:83.333%;}
.bw_col_11{width:91.666%;}
.bw_col_12{width:100%;}

.bw_color_color {color:#000}
.bw_color_background_color {background-color:#ddd}
.bw_color_active {active:#222}
.bw_thm_light
{
...
@media only screen and (min-width: 540px) {.bw_def_page_setup {width: 96%;}}
@media only screen and (min-width: 720px) {.bw_def_page_setup {width: 92%;}}
@media only screen and (min-width: 960px) {.bw_def_page_setup {width: 88%;}}
@media only screen and (min-width: 1100px){.bw_def_page_setup {width: 86%;}}
@media only screen and (min-width: 1600px){.bw_def_page_setup {width: 84%;}}
`
...
var myTabs = 
`
<div class="bw_tab_container">  <!-- bw_tab_container -- bw_tab_items (array of items), bw_tab_content (array of content to show) -->
    <ul class="bw_tab_item_list"> <!-- container for the tabs -->
        <li class="bw_tab userTab  bw_tab_active" onclick="bw.selectTabContent(this)" >Tab 1</li>
        <li class="bw_tab userTab  " onclick="bw.selectTabContent(this)" >Tab 2</li>
        <li class="bw_tab userTab  " onclick="bw.selectTabContent(this)" >Tab 3</li>
        <li class="bw_tab userTab  " onclick="bw.selectTabContent(this)" >Tab 4</li>
    </ul>
    <div class="bw_tab_content_list"> <!-- container for the tab content -->
        <div class="bw_tab_content bw_show" >coontent area 1 </div>  <!-- bw_show picks which tab to make active at first -->
        <div class="bw_tab_content" >content area 2</div>
        <div class="bw_tab_content" >content 3</div>
        <div class="bw_tab_content" >content 4</div>

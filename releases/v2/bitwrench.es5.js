...
(function (global, factory) {
  ...
  var structuralRules = {
    ...
    navigation: {
      ...
      '.bw_bccl_navbar > .bw_bccl_container, .bw_bccl_navbar > .bw_container': {
        'display': 'flex',
        'flex-wrap': 'wrap',
        'align-items': 'center',
        'justify-content': 'space-between'
    ...
    pagination: {
      ...
      '.bw_bccl_pagination_sm .bw_page_link': {
        'padding': '0.25rem 0.5rem',
        'font-size': '0.8125rem'
      },
      '.bw_bccl_pagination_lg .bw_page_link': {
  ...
  var _excluded$1 = ["type", "placeholder", "value", "id", "name", "disabled", "readonly", "required", "className", "style"],
    ...
    _excluded7 = ["min", "max", "step", "value", "label", "showValue", "id", "name", "disabled", "className"];
  /**
  ...
  function makeCard() {
    ...
    var cardClasses = ['bw_bccl_card', variantClass(variant), shadow ? shadowClasses[shadow] || '' : '', !bordered ? 'bw_border_0' : '', hoverable ? 'bw_bccl_card_hoverable' : '', className].filter(Boolean).join(' ').trim();
    var cardContent = [header && {
      t: 'div',
      a: {
        "class": "bw_bccl_card_header ".concat(headerClass).trim()
      },
      c: header
    }, image && (imagePosition === 'top' || imagePosition === 'left') && {
      t: 'img',
      a: {
        "class": "bw_bccl_card_img_".concat(imagePosition),
        src: image.src,
        alt: image.alt || ''
      }
    }, {
      t: 'div',
      a: {
        "class": "bw_bccl_card_body ".concat(bodyClass).trim()
      },
      c: [title && {
        t: 'h5',
        a: {
          "class": 'bw_bccl_card_title'
        },
        c: title
      }, subtitle && {
        t: 'h6',
      ...
      t: 'div',
      a: {
        "class": "bw_bccl_card_footer ".concat(footerClass).trim()
      },
      c: footer
    }].filter(Boolean);
  ...
  function makeButton() {
    ...
    return {
      ...
      a: {
        type: type,
        "class": ['bw_bccl_btn', variantClass(variant), size && "bw_bccl_btn_".concat(size), action && 'bw_act_' + action, className].filter(Boolean).join(' '),
        disabled: disabled,
        onclick: onclick,
        style: style
      },
  ...
  function makeContainer() {
    ...
    return {
      t: 'div',
      a: {
        "class": "bw_bccl_container".concat(fluid ? '_fluid' : '', " ").concat(className).trim()
      },
      c: children
    };
  }
  ...
  function makeRow() {
    ...
    return {
      t: 'div',
      a: {
        "class": "bw_bccl_row bw_row ".concat(gap != null ? "bw_g_".concat(gap) : '', " ").concat(className).trim()
      },
      c: children
    };
  }
  ...
  function makeCol() {
    ...
    if (_typeof(size) === 'object') {
      ...
      classes.push("bw_col_".concat(size));
    } else {
      classes.push('bw_col');
    }
    if (offset) classes.push("bw_offset_".concat(offset));
    if (push) classes.push("bw_push_".concat(push));
    if (pull) classes.push("bw_pull_".concat(pull));
    return {
      t: 'div',
      a: {
        "class": "bw_bccl_col ".concat(classes.join(' '), " ").concat(className).trim()
      },
      c: content || children
    };
  }
  ...
  function makeNav() {
    ...
    return {
      t: 'ul',
      a: {
        "class": "bw_bccl_nav bw_nav ".concat(pills ? 'bw_nav_pills' : 'bw_nav_tabs', " ").concat(vertical ? 'bw_nav_vertical' : '', " ").concat(className).trim()
      },
      c: items.map(function (item) {
        return {
          ...
          c: {
            ...
            a: {
              href: item.href || '#',
              "class": "bw_nav_link ".concat(item.active ? 'active' : '', " ").concat(item.disabled ? 'disabled' : '').trim()
            },
            c: item.text
          }
        };
  ...
  function makeNavbar() {
    ...
    return {
      t: 'nav',
      a: {
        "class": "bw_bccl_navbar ".concat(dark ? 'bw_bccl_navbar_dark' : 'bw_bccl_navbar_light', " ").concat(className).trim()
      },
      c: {
        t: 'div',
        a: {
        ...
        c: [brand && {
          ...
          a: {
            href: brandHref,
            "class": 'bw_bccl_navbar_brand'
          },
          c: brand
        }, items.length > 0 && {
          t: 'div',
          a: {
            "class": 'bw_bccl_navbar_nav'
          },
          c: items.map(function (item) {
            return {
              t: 'a',
              a: {
                href: item.href || '#',
                "class": "bw_nav_link ".concat(item.active ? 'active' : '')
              },
              c: item.text
            };
          })
  ...
  function makeTabs() {
    ...
    return {
      ...
      c: [{
        ...
        c: tabs.map(function (tab, index) {
          return {
            ...
            c: {
              t: 'button',
              a: {
                "class": "bw_nav_link ".concat(index === actualActiveIndex ? 'active' : ''),
                type: 'button',
                role: 'tab',
        ...
        t: 'div',
        a: {
          "class": 'bw_bccl_tab_content'
        },
        c: tabs.map(function (tab, index) {
          return {
            t: 'div',
            a: {
              "class": "bw_bccl_tab_pane ".concat(index === actualActiveIndex ? 'active' : ''),
              role: 'tabpanel'
            },
            c: tab.content
          };
  ...
  function makeAlert() {
    ...
    return {
      t: 'div',
      a: {
        "class": "bw_bccl_alert ".concat(variantClass(variant), " ").concat(dismissible ? 'bw_bccl_alert_dismissible' : '', " ").concat(className).trim(),
        role: 'alert'
      },
  ...
  function makeBadge() {
    ...
    var sizeClass = size === 'sm' ? ' bw_bccl_badge_sm' : size === 'lg' ? ' bw_bccl_badge_lg' : '';
    return {
      t: 'span',
      a: {
        "class": "bw_bccl_badge ".concat(variantClass(variant)).concat(sizeClass, " ").concat(pill ? 'bw_bccl_badge_pill' : '', " ").concat(className).trim()
      },
      c: text
    };
  }
  ...
  function makeProgress() {
    ...
    return {
      ...
      c: {
        t: 'div',
        a: {
          "class": ['bw_bccl_progress_bar', variantClass(variant), striped && 'bw_bccl_progress_bar_striped', animated && 'bw_bccl_progress_bar_animated'].filter(Boolean).join(' '),
          role: 'progressbar',
          style: {
  ...
  function makeListGroup() {
    ...
    return {
      t: 'div',
      a: {
        "class": "bw_bccl_listGroup bw_list_group ".concat(flush ? 'bw_list_group_flush' : '').trim()
      },
      c: items.map(function (item) {
        ...
        if (interactive || href || onclick) {
          return {
            t: 'a',
            a: {
              "class": ['bw_list_group_item', active && 'active', disabled && 'disabled'].filter(Boolean).join(' '),
              href: href || '#',
  ...
  function makeBreadcrumb() {
    ...
    return {
      ...
      c: {
        ...
        a: {
          "class": 'bw_bccl_breadcrumb_list'
        },
        c: items.map(function (item, _index) {
          return {
            t: 'li',
            a: {
              "class": "bw_bccl_breadcrumb_item ".concat(item.active ? 'active' : ''),
  ...
  function makeForm() {
    ...
    if (!fields) {
      return {
        t: 'form',
        a: {
          "class": "bw_bccl_form ".concat(className).trim(),
    ...
    var fieldItems = fields.map(function (field) {
      ...
      return {
        t: 'div',
        a: {
          "class": 'bw_bccl_form_group'
        },
        c: [field.label && {
          t: 'label',
          a: {
            "for": fieldId,
            "class": 'bw_bccl_form_label'
          },
          c: field.required ? [field.label, {
            t: 'span',
            a: {
              "class": 'bw_text_danger bw_ms_1'
            },
            c: '*'
          }] : field.label
        }, {
    ...
    return {
      ...
      o: {
        type: 'form',
        handle: {
          getValues: function getValues(el) {
            var values = {};
          ...
          setValues: function setValues(el, vals) {
            if (_typeof(vals) !== 'object') return;
          ...
          setErrors: function setErrors(el, errors) {
            if (_typeof(errors) !== 'object') return;
  ...
  function makeFormGroup() {
    ...
    return {
      ...
      }, styledInput, feedback && validation && {
        t: 'div',
        a: {
          "class": validation === 'valid' ? 'bw_valid_feedback' : 'bw_invalid_feedback'
        },
        c: feedback
      }, help && {
        t: 'small',
        a: {
          "class": 'bw_bccl_form_text bw_text_muted'
        },
        c: help
      }].filter(Boolean)
    };
  ...
  function makeInput() {
    ...
    return {
      ...
      a: _objectSpread2({
        type: type,
        "class": "bw_bccl_form_control ".concat(className).trim(),
  ...
  function makeCheckbox() {
    ...
    return {
      t: 'div',
      a: {
        "class": "bw_bccl_form_check ".concat(className).trim()
      },
      c: [{
        t: 'input',
        a: _objectSpread2({
        ...
        t: 'label',
        a: {
          "class": 'bw_bccl_form_check_label',
          "for": id
        },
        c: label
      }].filter(Boolean)
  ...
  function makeStack() {
    ...
    return {
      t: 'div',
      a: {
        "class": "bw_bccl_stack bw_".concat(direction === 'vertical' ? 'vstack' : 'hstack', " bw_gap_").concat(gap, " ").concat(className).trim()
      },
      c: children
    };
  }
  ...
  function makeSpinner() {
    ...
    return {
      ...
      a: {
        ...
        "class": "bw_bccl_spinner bw_spinner_".concat(type, " bw_spinner_").concat(type, "_").concat(size, " ").concat(variantClass(variant)),
        role: 'status'
      },
      c: {
        t: 'span',
        a: {
          "class": 'bw_visually_hidden'
        },
        c: 'Loading...'
      }
    };
  ...
  function makeHero() {
    ...
    return {
      t: 'section',
      a: {
        "class": "bw_bccl_hero ".concat(variantClass(variant), " ").concat(sizeClasses[size] || sizeClasses.lg, " ").concat(centered ? 'bw_text_center' : '', " ").concat(className).trim(),
      ...
      c: [overlay && {
        ...
        c: {
          ...
          c: [title && {
            ...
            t: 'div',
            a: {
              "class": 'bw_bccl_hero_actions bw_mt_4'
            },
            c: actions
          }].filter(Boolean)
        }
  ...
  function makeFeatureGrid() {
    ...
    var colClass = "bw_col_md_".concat(Math.min(12, Math.max(1, Math.round(12 / columns))));
    return {
      t: 'div',
      a: {
        "class": "bw_bccl_featureGrid bw_feature_grid ".concat(className).trim()
      },
      c: {
        t: 'div',
        a: {
        ...
        c: features.map(function (feature) {
          return {
            ...
            c: {
              t: 'div',
              a: {
                "class": "bw_feature ".concat(centered ? 'bw_text_center' : '')
              },
              c: [feature.icon && {
                t: 'div',
                a: {
                ...
                t: 'h3',
                a: {
                  "class": 'bw_feature_title bw_h5 bw_mb_2'
                },
                c: feature.title
              }, feature.description && {
                t: 'p',
                a: {
                  "class": 'bw_feature_description bw_text_muted'
                },
  ...
  function makeCTA() {
    ...
    return {
      t: 'section',
      a: {
        "class": "bw_bccl_cta bw_cta bw_bg_".concat(variant, " bw_py_5 ").concat(className).trim()
      },
      c: {
        t: 'div',
        a: {
        ...
        c: {
          t: 'div',
          a: {
            "class": "bw_cta_content ".concat(centered ? 'bw_text_center' : '')
          },
          c: [title && {
            t: 'h2',
            a: {
              "class": 'bw_cta_title bw_mb_3'
            },
            c: title
          }, description && {
            t: 'p',
            a: {
              "class": 'bw_cta_description bw_lead bw_mb_4'
            },
            c: description
          }, actions && {
            t: 'div',
            a: {
              "class": 'bw_cta_actions'
            },
            c: actions
          }].filter(Boolean)
        }
  ...
  function makeSection() {
    ...
    return {
      t: 'section',
      a: {
        "class": "bw_bccl_section bw_section ".concat(spacingClasses[spacing] || spacingClasses.md, " ").concat(variant !== 'default' ? "bw_bg_".concat(variant) : '', " ").concat(className).trim()
      },
      c: {
        t: 'div',
        a: {
        ...
        c: [(title || subtitle) && {
          t: 'div',
          a: {
            "class": 'bw_section_header bw_text_center bw_mb_5'
          },
          c: [title && {
            t: 'h2',
            a: {
              "class": 'bw_section_title'
            },
            c: title
          }, subtitle && {
            t: 'p',
            a: {
              "class": 'bw_section_subtitle bw_text_muted'
            },
            c: subtitle
          }].filter(Boolean)
  ...
  function makeCodeDemo() {
        ...
        content: {
          ...
          typeof globalThis !== 'undefined' && typeof globalThis.bw !== 'undefined' && typeof globalThis.bw.codeEditor === 'function' ? globalThis.bw.codeEditor({
            ...
            c: {
              t: 'code',
              a: {
                "class": "bw_code_block language-".concat(language)
              },
              c: code
            }
          }]
    ...
    return {
      t: 'div',
      a: {
        "class": 'bw_bccl_codeDemo bw_code_demo'
      },
      c: content
    };
  }
  ...
  function makePagination() {
    ...
    return {
      ...
      c: {
        t: 'ul',
        a: {
          "class": "bw_bccl_pagination ".concat(size ? 'bw_bccl_pagination_' + size : '', " ").concat(className).trim()
        },
        c: items
      },
      o: {
  ...
  function makeButtonGroup() {
    ...
    return {
      t: 'div',
      a: {
        "class": "".concat(vertical ? 'bw_bccl_btn_group_vertical' : 'bw_bccl_btn_group', " ").concat(size ? 'bw_bccl_btn_group_' + size : '', " ").concat(className).trim(),
        role: 'group'
      },
      c: children
    };
  ...
  function makeAccordion() {
    ...
    return {
      t: 'div',
      a: {
        "class": "bw_bccl_accordion ".concat(className).trim()
      },
      c: items.map(function (item, index) {
        ...
        return {
          t: 'div',
          a: {
            "class": 'bw_bccl_accordion_item'
          },
          c: [{
            t: 'h2',
            a: {
              "class": 'bw_bccl_accordion_header'
            },
            c: {
              t: 'button',
              a: {
                "class": "bw_bccl_accordion_button ".concat(item.open ? '' : 'bw_collapsed').trim(),
                type: 'button',
                ...
                onclick: function onclick(e) {
                  ...
                  if (isOpen) {
                    ...
                    var _onEnd = function onEnd(ev) {
                      ...
                      collapse.removeEventListener('transitionend', _onEnd);
                    };
                    collapse.addEventListener('transitionend', _onEnd);
                  }
                }
              },
              c: item.title
            ...
            a: {
              id: panelId,
              "class": "bw_bccl_accordion_collapse ".concat(item.open ? 'bw_collapse_show' : '').trim()
            },
            c: {
              t: 'div',
              a: {
                "class": 'bw_bccl_accordion_body'
              },
              c: item.content
            },
            o: item.open ? {
  ...
  function makeModal() {
    ...
    var title = props.title,
      ...
      closeLabel = _props$closeLabel === void 0 ? 'Close' : _props$closeLabel,
    ...
    return {
      t: 'div',
      a: {
        "class": "bw_bccl_modal ".concat(open ? 'bw_bccl_modal_show' : '', " ").concat(className).trim(),
        style: open ? 'display:flex' : undefined
      },
      c: {
        t: 'div',
        a: {
          "class": "bw_bccl_modal_dialog ".concat(size ? 'bw_bccl_modal_' + size : '').trim(),
          role: 'dialog',
          'aria-modal': 'true'
        },
        c: {
          t: 'div',
          a: {
            "class": 'bw_bccl_modal_content'
          },
          c: [(title || closeButton) && {
            t: 'div',
            a: {
              "class": 'bw_bccl_modal_header'
            },
            c: [title && {
              t: 'h5',
              a: {
                "class": 'bw_bccl_modal_title'
              },
              c: title
            }, closeButton && {
              t: 'button',
            ...
            t: 'div',
            a: {
              "class": 'bw_bccl_modal_body'
            },
            c: content
          }, footer && {
            t: 'div',
            a: {
              "class": 'bw_bccl_modal_footer'
            },
            c: footer
          }].filter(Boolean)
        }
      ...
      o: {
        ...
        mounted: function mounted(el) {
          ...
          var docEscHandler = function docEscHandler(e) {
  ...
  function makeToast() {
    ...
    return {
      t: 'div',
      a: {
        "class": "bw_bccl_toast ".concat(variantClass(variant), " bw_bccl_toast_").concat(position.replace(/-/g, '_'), " ").concat(className).trim(),
        role: 'alert'
      },
      c: [title && {
        t: 'div',
        a: {
          "class": 'bw_bccl_toast_header'
        },
        c: [{
          t: 'strong',
          c: title
  ...
  function makeDropdown() {
    ...
    if (typeof trigger === 'string' || trigger === undefined) {
      triggerTaco = {
        t: 'button',
        a: {
          "class": "bw_bccl_btn ".concat(variantClass(variant), " bw_bccl_dropdown_toggle"),
          type: 'button',
          onclick: function onclick(e) {
    ...
    return {
      t: 'div',
      a: {
        "class": "bw_bccl_dropdown ".concat(className).trim()
      },
      c: [triggerTaco, {
        t: 'div',
        a: {
          "class": "bw_bccl_dropdown_menu ".concat(align === 'end' ? 'bw_bccl_dropdown_menu_end' : '').trim()
        },
        c: items.map(function (item) {
          if (item.divider) {
            return {
              t: 'hr',
              a: {
                "class": 'bw_bccl_dropdown_divider'
              }
            };
          }
          return {
            t: 'a',
            a: {
              "class": "bw_bccl_dropdown_item ".concat(item.disabled ? 'disabled' : '').trim(),
              href: item.href || '#',
  ...
  function makeSwitch() {
    ...
    return {
      t: 'div',
      a: {
        "class": "bw_bccl_form_check bw_bccl_form_switch ".concat(className).trim()
      },
      c: [{
        t: 'input',
        a: _objectSpread2({
  ...
  function makeSkeleton() {
    ...
    if (variant === 'circle') {
      ...
      return {
        t: 'div',
        a: {
          "class": "bw_bccl_skeleton bw_skeleton bw_skeleton_circle ".concat(className).trim(),
          style: {
            width: circleSize,
            height: circleSize
          }
    ...
    if (variant === 'rect') {
      return {
        t: 'div',
        a: {
          "class": "bw_bccl_skeleton bw_skeleton bw_skeleton_rect ".concat(className).trim(),
          style: {
            width: width || '100%',
            height: height || '120px'
          }
    ...
    if (count === 1) {
      return {
        t: 'div',
        a: {
          "class": "bw_bccl_skeleton bw_skeleton bw_skeleton_text ".concat(className).trim(),
          style: {
            width: width || '100%',
            height: height || '1em'
          }
    ...
    return {
      t: 'div',
      a: {
        "class": "bw_bccl_skeleton bw_skeleton_group ".concat(className).trim()
      },
      c: lines
    };
  }
  ...
  function makeAvatar() {
    ...
    if (src) {
      return {
        t: 'img',
        a: {
          "class": "bw_bccl_avatar bw_avatar bw_avatar_".concat(size, " ").concat(className).trim(),
          src: src,
          alt: alt
        }
      };
    ...
    return {
      t: 'div',
      a: {
        "class": "bw_bccl_avatar bw_avatar bw_avatar_".concat(size, " ").concat(variantClass(variant), " ").concat(className).trim()
      },
      c: initials || ''
    };
  }
  ...
  function makeCarousel() {
    ...
    var _props$items7 = props.items,
      ...
      _props$prevLabel = props.prevLabel,
      prevLabel = _props$prevLabel === void 0 ? 'Previous slide' : _props$prevLabel,
      _props$nextLabel = props.nextLabel,
      nextLabel = _props$nextLabel === void 0 ? 'Next slide' : _props$nextLabel,
    ...
    var slides = items.map(function (item) {
      var slideContent = [item.content, item.caption && {
        t: 'div',
        a: {
          "class": 'bw_bccl_carousel_caption'
        },
        c: item.caption
      }].filter(Boolean);
      return {
    ...
    if (showIndicators && items.length > 1) {
      children.push({
        t: 'div',
        a: {
          "class": 'bw_bccl_carousel_indicators'
        },
  ...
  function makeStatCard() {
    ...
    var _props4 = props,
      ...
      value = _props4$value === void 0 ? 0 : _props4$value,
      label = _props4.label,
      ...
      className = _props4$className === void 0 ? '' : _props4$className,
      style = _props4.style;
    ...
    var classes = ['bw_bccl_statCard bw_stat_card', variantClass(variant), className].filter(Boolean).join(' ').trim();
    var children = [];
    if (icon) {
      children.push({
        t: 'div',
  ...
  function makeTooltip() {
    ...
    return {
      t: 'span',
      a: {
        "class": ('bw_bccl_tooltip_wrapper ' + className).trim()
      },
      c: [content, {
        t: 'span',
        a: {
  ...
  function makePopover() {
    ...
    var trigger = props.trigger,
      ...
      placement = _props$placement2 === void 0 ? 'top' : _props$placement2,
      _props$className28 = props.className,
      className = _props$className28 === void 0 ? '' : _props$className28;
    var popoverContent = [title && {
      t: 'div',
      a: {
        "class": 'bw_popover_header'
      },
      c: title
    }, content && {
      t: 'div',
      a: {
        "class": 'bw_popover_body'
      },
      c: content
    }].filter(Boolean);
    return {
      t: 'span',
      a: {
        "class": ('bw_bccl_popover bw_popover_wrapper ' + className).trim()
      },
      c: [{
        t: 'span',
        a: {
  ...
  function makeSearchInput() {
    ...
    var _props5 = props,
      ...
      placeholder = _props5$placeholder === void 0 ? 'Search...' : _props5$placeholder,
      value = _props5.value,
      onSearch = _props5.onSearch,
      onInput = _props5.onInput,
      id = _props5.id,
      name = _props5.name,
      _props5$className = _props5.className,
      className = _props5$className === void 0 ? '' : _props5$className;
    return {
      t: 'div',
      a: {
        "class": ('bw_bccl_searchInput bw_search_input ' + className).trim()
      },
      c: [{
        t: 'input',
        a: {
  ...
  function makeRange() {
    ...
    var _props$min = props.min,
      ...
      value = _props$value2 === void 0 ? 50 : _props$value2,
      label = props.label,
      _props$showValue = props.showValue,
      showValue = _props$showValue === void 0 ? false : _props$showValue,
      id = props.id,
      name = props.name,
      _props$disabled8 = props.disabled,
      disabled = _props$disabled8 === void 0 ? false : _props$disabled8,
      _props$className29 = props.className,
      className = _props$className29 === void 0 ? '' : _props$className29,
      eventHandlers = _objectWithoutProperties(props, _excluded7);
    var children = [];
    if (label || showValue) {
      var labelContent = [];
      if (label) {
    ...
    return {
      t: 'div',
      a: {
        "class": ('bw_bccl_range bw_range_wrapper ' + className).trim()
      },
      c: children,
      o: {
        type: 'range'
   ...
   * });
   */
  function makeMediaObject() {
    var props = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    var src = props.src,
      _props$alt2 = props.alt,
      alt = _props$alt2 === void 0 ? '' : _props$alt2,
      title = props.title,
      content = props.content,
      _props$reverse = props.reverse,
      reverse = _props$reverse === void 0 ? false : _props$reverse,
      _props$imageSize = props.imageSize,
      imageSize = _props$imageSize === void 0 ? '3rem' : _props$imageSize,
      _props$className30 = props.className,
      className = _props$className30 === void 0 ? '' : _props$className30;
    var imgEl = src ? {
      t: 'img',
      a: {
        "class": 'bw_media_img',
    ...
    return {
      t: 'div',
      a: {
        "class": ('bw_bccl_mediaObject bw_media ' + (reverse ? 'bw_media_reverse ' : '') + className).trim()
      },
      c: reverse ? [bodyEl, imgEl].filter(Boolean) : [imgEl, bodyEl].filter(Boolean),
      o: {
        type: 'media-object'
      }
    };
  ...
  function makeFileUpload() {
    ...
    var accept = props.accept,
      ...
      text = _props$text2 === void 0 ? 'Drop files here or click to browse' : _props$text2,
      id = props.id,
      _props$className31 = props.className,
      className = _props$className31 === void 0 ? '' : _props$className31;
    return {
      t: 'div',
      a: {
      ...
      c: [{
        t: 'div',
        a: {
          "class": 'bw_file_upload_icon'
        },
        c: "\uD83D\uDCC1"
      }, {
        t: 'div',
        a: {
          "class": 'bw_file_upload_text'
        },
        c: text
      }, {
        t: 'input',
  ...
  function makeTimeline() {
    var props = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    var _props$items8 = props.items,
      items = _props$items8 === void 0 ? [] : _props$items8,
      _props$className32 = props.className,
      className = _props$className32 === void 0 ? '' : _props$className32;
    return {
      t: 'div',
      a: {
        "class": ('bw_bccl_timeline ' + className).trim()
      },
      c: items.map(function (item) {
        return {
          t: 'div',
          a: {
            "class": 'bw_bccl_timeline_item'
          },
          c: [{
            t: 'div',
            a: {
              "class": 'bw_bccl_timeline_marker ' + variantClass(item.variant || 'primary')
            }
          }, {
            t: 'div',
            a: {
              "class": 'bw_bccl_timeline_content'
            },
            c: [item.date && {
              t: 'div',
              a: {
                "class": 'bw_bccl_timeline_date'
              },
              c: item.date
            }, item.title && {
              t: 'h5',
              a: {
                "class": 'bw_bccl_timeline_title'
              },
              c: item.title
            }, item.content && (typeof item.content === 'string' ? {
              t: 'p',
              a: {
                "class": 'bw_bccl_timeline_text'
              },
              c: item.content
  ...
  function makeStepper() {
    ...
    var _props$steps = props.steps,
      ...
      _props$className33 = props.className,
      className = _props$className33 === void 0 ? '' : _props$className33;
    return {
      t: 'div',
      a: {
        "class": ('bw_bccl_stepper bw_stepper ' + className).trim(),
        role: 'list'
      },
  ...
  function makeChipInput() {
    ...
    var _props$chips = props.chips,
      ...
      placeholder = _props$placeholder === void 0 ? 'Add...' : _props$placeholder,
      onAdd = props.onAdd,
      onRemove = props.onRemove,
      _props$className34 = props.className,
      className = _props$className34 === void 0 ? '' : _props$className34;
    ...
    return {
      t: 'div',
      a: {
        "class": ('bw_bccl_chipInput bw_chip_input ' + className).trim()
      },
      c: [].concat(_toConsumableArray(chips.map(makeChipEl)), [{
        t: 'input',
        a: {
          type: 'text',
          "class": 'bw_chip_field',
  ...
  var BCCL = {
    ...
    searchInput: {
      make: makeSearchInput
    },
    range: {
      make: makeRange
    },
    mediaObject: {
      make: makeMediaObject
    },
    fileUpload: {
      make: makeFileUpload
    },
  ...
  var _cssProp = function _cssProp(k) {
    if (k.indexOf('--') === 0) return k; // custom property, leave alone
    var out = k.replace(/[A-Z]/g, function (c) {
  ...
  var _flat2 = function _flat(arr) {
    for (var i = 0; i < arr.length; i++) {
      if (_isA(arr[i])) {
        var out = arr.slice(0, i);
        for (; i < arr.length; i++) {
          if (_isA(arr[i])) out.push.apply(out, _flat2(arr[i]));else out.push(arr[i]);
        }
        return out;
      }
    }
  ...
  function _applyTo(el, apply) {
    if (_is(apply, 'function')) {
      ...
      el.innerHTML = '';
      _flat2(apply).forEach(function (item) {
  ...
  var _escapeAttr = function _escapeAttr(str) {
    if (!_is(str, 'string')) return '';
    return str.replace(/[&<>"']/g, function (c) {
      ...
      if (key === 'style' && _is(value, 'object')) {
        ...
        var styleStr = Object.entries(value).filter(function (_ref) {
          ...
          var _ref4 = _slicedToArray(_ref3, 2),
            k = _ref4[0],
            v = _ref4[1];
          return "".concat(_cssProp(k), ":").concat(v);
        }).join(';');
        if (styleStr) {
          attrStr += " style=\"".concat(_escapeAttr(styleStr), "\"");
        }
      } else if (key === 'class') {
        ...
        attrStr += " ".concat(key, "=\"").concat(_escapeAttr(resolvedVal), "\"");
      }
    }
  ...
  bw.htmlPage = function (opts) {
    ...
    // Assemble document
    var parts = ['<!DOCTYPE html>', '<html lang="' + _escapeAttr(lang) + '">', '<head>', '<meta charset="UTF-8">', '<meta name="viewport" content="width=device-width, initial-scale=1">'];
  ...
  bw.makeTable = function (config) {
    ...
    function _sorted(rows, column, dir) {
      ...
      out.sort(function (a, b) {
        ...
        var aStr = _cellText(aVal).toLowerCase(),
          bStr = _cellText(bVal).toLowerCase();
    ...
    var first = _view(data, sortColumn || null, sortDirection);
    var totalPages = first.pages;
    var page = first.offset / (pageSize || 1) + 1;
    ...
    function _thContent(col, column, dir) {
      return sortable && col.key === column ? [col.label, {
        t: 'span',
        a: {
          style: {
            marginLeft: '5px'
      ...
      c: {
        ...
        c: cols.map(function (col) {
          ...
          return {
            t: 'th',
            a: thAttrs,
            c: _thContent(col, sortColumn, sortDirection)
          };
        })
      }
    };
    ...
    function _cellSig(v) {
      if (v == null) return '';
      if (_typeof(v) !== 'object') return 's:' + String(v);
      return 'o:' + JSON.stringify(v, function (k, val) {
        return typeof val === 'function' ? "\u0192" : val;
      });
    }
    ...
    function _rowTaco(row) {
      var contents = cols.map(function (col) {
        return _cellContent(col, row);
      });
      if (rowKey) _sigs[String(row[rowKey])] = contents.map(_cellSig);
      return {
        t: 'tr',
        a: selectable || onRowClick ? {
          style: 'cursor:pointer;'
        } : {},
        c: contents.map(function (c) {
          return {
            t: 'td',
            c: c
          };
    ...
    function _sortTableDOM(el, column, direction) {
      ...
      for (var h = 0; h < ths.length && h < cols.length; h++) {
        if (cols[h].key === column) ths[h].setAttribute('aria-sort', direction === 'asc' ? 'ascending' : 'descending');else ths[h].removeAttribute('aria-sort');
    ...
    function _rebuildTbody(el, rows) {
      ...
      if (rowKey) {
        state.rowKeys = rows.map(function (row) {
          return String(row[rowKey]);
        });
        var live = {};
        state.rowKeys.forEach(function (k) {
          live[k] = _sigs[k];
        });
    ...
    function _pagerContent(pageNum, pages) {
      return [{
        ...
        a: {
          ...
          onclick: pageNum > 1 && onPageChange ? function () {
        ...
        c: 'Page ' + pageNum + ' of ' + pages
      }, {
        t: 'button',
        a: {
          "class": 'bw_bccl_btn bw_bccl_btn_sm',
          disabled: pageNum >= pages ? 'disabled' : undefined,
          onclick: pageNum < pages && onPageChange ? function () {
            onPageChange(pageNum + 1);
          } : undefined
        },
        c: 'Next'
    ...
    var table = {
      ...
      o: {
        ...
        state: {
          ...
          view: first.rows,
          offset: first.offset,
          rowKeys: rowKey ? first.rows.map(function (row) {
            return String(row[rowKey]);
          }) : null
        },
        handle: {
    ...
    var bars = data.map(function (d, i) {
      ...
      if (showLabels) {
        children.push({
          ...
          c: d[labelKey] == null ? '' : String(d[labelKey])
        });
      }
      return {
        t: 'div',

...
/**
   ...
   */function t(e,t){void 0===t&&(t=255);var o=[0,0,0,t,"rgb"];if(Array.isArray(e)){for(var n=[0,0,0,255,"rgb"],a=0;a<e.length&&a<n.length;a++)n[a]=e[a];return n}if("#"===(e=String(e).replace(/\s/g,""))[0]){var i=e.slice(1);if(3===i.length||4===i.length)for(var l=0;l<i.length;l++)o[l]=parseInt(i[l]+i[l],16);else if(6===i.length||8===i.length)for(var s=0;s<i.length;s+=2)o[s/2]=parseInt(i.substring(s,s+2),16)}else{var c=e.match(/^(rgb|hsl)a?\(([^)]+)\)$/i);if(c){var d=c[1].toLowerCase(),b=c[2].split(",").map(function(e){return parseFloat(e)});if("rgb"===d)o[0]=b[0]||0,o[1]=b[1]||0,o[2]=b[2]||0,o[3]=void 0!==b[3]?255*b[3]:t,o[4]="rgb";else if("hsl"===d){return r(b[0]||0,b[1]||0,b[2]||0,void 0!==b[3]?255*b[3]:t)}}}return o}function r(e,t,r,o,n){void 0===o&&(o=255),void 0===n&&(n=!0),Array.isArray(e)&&(t=e[1],r=e[2],o=void 0!==e[3]?e[3]:255,e=e[0]);var a,i,l,s=e/360,c=t/100,d=r/100;if(0===c)a=i=l=255*d;else{var b=function(e,t,r){return r<0&&(r+=1),r>1&&(r-=1),r<1/6?e+6*(t-e)*r:r<.5?t:r<2/3?e+(t-e)*(2/3-r)*6:e},m=d<.5?d*(1+c):d+c-d*c,p=2*d-m;a=255*b(p,m,s+1/3),i=255*b(p,m,s),l=255*b(p,m,s-1/3)}return n&&(a=Math.round(a),i=Math.round(i),l=Math.round(l),o=Math.round(o)),[a,i,l,o,"rgb"]}function o(e){var r=t(e),o=function(e,t,r,o){void 0===o&&(o=255),Array.isArray(e)&&(t=e[1],r=e[2],o=void 0!==e[3]?e[3]:255,e=e[0]),e/=255,t/=255,r/=255;var n,a,i=Math.max(e,t,r),l=Math.min(e,t,r),s=(i+l)/2;if(i===l)n=a=0;else{var c=i-l;switch(a=s>.5?c/(2-i-l):c/(i+l),i){case e:n=((t-r)/c+(t<r?6:0))/6;break;case t:n=((r-e)/c+2)/6;break;case r:n=((e-t)/c+4)/6}}return[n*=360,a*=100,s*=100,o,"hsl"]}(r[0],r[1],r[2],255);return[o[0],o[1],o[2]]}function n(e){var t=r(e[0],e[1],e[2],255,!0);return"#"+("0"+t[0].toString(16)).slice(-2)+("0"+t[1].toString(16)).slice(-2)+("0"+t[2].toString(16)).slice(-2)}function a(e,t){var r,a,i,l=o(e);return l[2]=(r=l[2]+t,a=0,i=100,Math.max(a,Math.min(i,r))),n(l)}function i(e,r,o){var n=t(e),a=t(r),i=Math.round(n[0]+(a[0]-n[0])*o),l=Math.round(n[1]+(a[1]-n[1])*o),s=Math.round(n[2]+(a[2]-n[2])*o);return"#"+("0"+i.toString(16)).slice(-2)+("0"+l.toString(16)).slice(-2)+("0"+s.toString(16)).slice(-2)}function l(e){var r=t(e),o=[r[0]/255,r[1]/255,r[2]/255].map(function(e){return e<=.03928?e/12.92:Math.pow((e+.055)/1.055,2.4)});return.2126*o[0]+.7152*o[1]+.0722*o[2]}function s(e){return l(e)>.179?"#000":"#fff"}function c(e){var r=t(e);return{base:e,hover:a(e,-10),active:a(e,-15),light:i(e,"#ffffff",.85),darkText:a(e,-40),border:i(e,"#ffffff",.6),focus:"rgba("+r[0]+","+r[1]+","+r[2]+",0.25)",textOn:s(e)}}function d(e){var t="#198754",r="#dc3545",o="#ffc107",n="#0dcaf0",a="#f8f9fa",i="#212529";return{primary:c(e.primary),secondary:c(e.secondary),tertiary:c(e.tertiary),success:c(e.success||t),danger:c(e.danger||r),warning:c(e.warning||o),info:c(e.info||n),light:c(e.light||a),dark:c(e.dark||i)}}
/**

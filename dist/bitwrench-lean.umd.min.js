...
/**
   ...
   * @license BSD-2-Clause
   * @author M A Chatterjee <deftio [at] deftio [dot] com>
   */const R={version:e.version,versionInfo:e,getVersion:function(){return{...e}},_idCounter:0,_unmountCallbacks:new Map,_topics:{},_subIdCounter:0,_nodeMap:{},__monkey_patch_is_nodejs__:{_value:"ignore",set:function(e){this._value="boolean"==typeof e?e:"ignore"},get:function(){return this._value}}};function U(e){this._bwComponent=!0,this._bwId=R.uuid("comp"),this.taco=e,this.element=null,this.mounted=!1;var t=e.o||{};if(this._state={},t.state)for(var r in t.state)Object.prototype.hasOwnProperty.call(t.state,r)&&(this._state[r]=t.state[r]);if(this._actions={},t.actions)for(var o in t.actions)Object.prototype.hasOwnProperty.call(t.actions,o)&&(this._actions[o]=t.actions[o]);this._hooks={willMount:t.willMount||null,mounted:t.mounted||null,willUpdate:t.willUpdate||null,onUpdate:t.onUpdate||null,unmount:t.unmount||null,willDestroy:t.willDestroy||null},this._bindings=[],this._dirtyKeys={},this._scheduled=!1,this._subs=[],this._eventListeners=[],this._registeredActions=[],this._prevValues={},this._compile=!!t.compile,this._bw_refs={},this._refCounter=0}return R.isNodeJS=function(){return"ignore"!==R.__monkey_patch_is_nodejs__.get()?R.__monkey_patch_is_nodejs__.get():"undefined"!=typeof process&&null!=process.versions&&null!=process.versions.node},R._isNode=R.isNodeJS(),Object.defineProperty(R,"_isBrowser",{get:function(){return"undefined"!=typeof document&&"undefined"!=typeof window},configurable:!0}),R._fsCache=void 0,R._getFs=function(){if(void 0!==R._fsCache)return Promise.resolve(R._fsCache);if(!R.isNodeJS())return R._fsCache=null,Promise.resolve(null);if("function"==typeof require)try{return R._fsCache=require("fs"),Promise.resolve(R._fsCache)}catch(e){}try{return new Function("m","return import(m)")("fs").then(function(e){return R._fsCache=e.default||e,R._fsCache}).catch(function(){return R._fsCache=null,null})}catch(e){return R._fsCache=null,Promise.resolve(null)}},R.typeOf=$,R.to=R.typeOf,R.uuid=function(e){var t=e?"bw_"+e+"_":"bw_";if(R._isBrowser&&crypto&&crypto.randomUUID)return t+crypto.randomUUID().replace(/-/g,"");return`${t}${Date.now().toString(36)}_${(++R._idCounter).toString(36)}_${Math.random().toString(36).substring(2,11)}`},R._el=function(e){if("string"!=typeof e)return e||null;if(!e)return null;if(!R._isBrowser)return null;var t=R._nodeMap[e];if(t){if(null!==t.parentNode)return t;delete R._nodeMap[e]}var r=document.getElementById(e);return r||"#"!==e.charAt(0)&&"."!==e.charAt(0)||(r=document.querySelector(e)),r||(r=document.querySelector('[data-bw_id="'+e+'"]')),r&&(R._nodeMap[e]=r),r},R._registerNode=function(e,t){if(e){t&&(R._nodeMap[t]=e);var r=e.getAttribute?e.getAttribute("id"):null;r&&(R._nodeMap[r]=e)}},R._deregisterNode=function(e,t){t&&delete R._nodeMap[t];var r=e&&e.getAttribute?e.getAttribute("id"):null;r&&delete R._nodeMap[r]},R.escapeHTML=function(e){if("string"!=typeof e)return"";const t={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;","/":"&#x2F;"};return e.replace(/[&<>"'/]/g,e=>t[e])},R.raw=function(e){return{__bw_raw:!0,v:String(e)}},R.html=function(e,t={}){if(null==e)return"";if(e&&!0===e._bwComponent){var r=Object.assign({},t);return!r.state&&e._state&&(r.state=e._state),R.html(e.taco,r)}if(Array.isArray(e))return e.map(e=>R.html(e,t)).join("");if(e&&e.__bw_raw)return e.v;if(e&&e._bwWhen&&t.state){var o=e.expr.replace(/^\$\{|\}$/g,""),n=(t.compile?R._resolveTemplate("${"+o+"}",t.state,!0):R._evaluatePath(t.state,o))?e.branches[0]:e.branches[1]||null;return n?R.html(n,t):""}if(e&&e._bwEach&&t.state){var i=e.expr.replace(/^\$\{|\}$/g,""),a=R._evaluatePath(t.state,i);return Array.isArray(a)?a.map(function(r,o){return R.html(e.factory(r,o),t)}).join(""):""}if("object"!=typeof e||!e.t){var s=t.raw?String(e):R.escapeHTML(String(e));return t.state&&"string"==typeof s&&s.indexOf("${")>=0&&(s=R._resolveTemplate(s,t.state,!!t.compile)),s}const{t:l,a:c={},c:d,o:b={}}=e,_=["area","base","br","col","embed","hr","img","input","link","meta","param","source","track","wbr"].includes(l.toLowerCase());let p="";for(const[e,r]of Object.entries(c))if(null!=r&&!1!==r&&!e.startsWith("on"))if("style"===e&&"object"==typeof r){const e=Object.entries(r).filter(([,e])=>null!=e).map(([e,t])=>`${e}:${t}`).join(";");e&&(p+=` style="${R.escapeHTML(e)}"`)}else if("class"===e){const e=Array.isArray(r)?r.filter(Boolean).join(" "):String(r);e&&(p+=` class="${R.escapeHTML(e)}"`)}else if(!0===r)p+=` ${e}`;else{let o=String(r);t.state&&o.indexOf("${")>=0&&(o=R._resolveTemplate(o,t.state,!!t.compile)),p+=` ${e}="${R.escapeHTML(o)}"`}if((b.mounted||b.unmount)&&!c.class?.includes("bw_id_")){const e=b.bw_id||R.uuid();p=p.replace(/class="([^"]*)"/,(t,r)=>`class="${r} bw_id_${e}"`.trim()),p.includes("class=")||(p+=` class="bw_id_${e}"`)}if(_)return`<${l}${p} />`;let m=null!=d?R.html(d,t):"";return t.state&&"string"==typeof m&&m.indexOf("${")>=0&&(m=R._resolveTemplate(m,t.state,!!t.compile)),`<${l}${p}>${m}</${l}>`},R.createDOM=function(e,t={}){if(!R._isBrowser)throw new Error("bw.createDOM requires a DOM environment (document/window). Use bw.html() instead.");if(null==e)return document.createTextNode("");if(e&&e.__bw_raw){var r=document.createDocumentFragment(),o=document.createElement("span");for(o.innerHTML=e.v;o.firstChild;)r.appendChild(o.firstChild);return r}if("object"!=typeof e||!e.t)return document.createTextNode(String(e));const{t:n,a:i={},c:a,o:s={}}=e,l=document.createElement(n);for(const[e,t]of Object.entries(i))if(null!=t&&!1!==t)if("style"===e&&"object"==typeof t)Object.assign(l.style,t);else if("class"===e){const e=Array.isArray(t)?t.filter(Boolean).join(" "):String(t);e&&(l.className=e)}else if(e.startsWith("on")&&"function"==typeof t){const r=e.slice(2).toLowerCase();l.addEventListener(r,t)}else"value"===e&&"input"===n?l.value=t:!0===t?l.setAttribute(e,""):l.setAttribute(e,String(t));if(null!=a)if(Array.isArray(a))a.forEach(e=>{if(null!=e){var r=R.createDOM(e,t);l.appendChild(r);var o=e&&e.a?e.a["data-bw_id"]||e.a.id:null;if(o&&(l._bw_refs||(l._bw_refs={}),l._bw_refs[o]=r),r._bw_refs)for(var n in l._bw_refs||(l._bw_refs={}),r._bw_refs)Object.prototype.hasOwnProperty.call(r._bw_refs,n)&&(l._bw_refs[n]=r._bw_refs[n])}});else if("object"==typeof a&&a.__bw_raw)l.innerHTML=a.v;else if("object"==typeof a&&a.t){var c=R.createDOM(a,t);l.appendChild(c);var d=a.a?a.a["data-bw_id"]||a.a.id:null;if(d&&(l._bw_refs||(l._bw_refs={}),l._bw_refs[d]=c),c._bw_refs)for(var b in l._bw_refs||(l._bw_refs={}),c._bw_refs)Object.prototype.hasOwnProperty.call(c._bw_refs,b)&&(l._bw_refs[b]=c._bw_refs[b])}else l.textContent=String(a);if(i.id&&R._registerNode(l,null),s.mounted||s.unmount||s.render||s.state){const e=i["data-bw_id"]||R.uuid();l.setAttribute("data-bw_id",e),R._registerNode(l,e),s.state&&(l._bw_state=s.state),s.render?(l._bw_render=s.render,s.mounted&&console.warn("bw.createDOM: o.render and o.mounted are mutually exclusive. o.render wins."),document.body.contains(l)?s.render(l,l._bw_state||{}):requestAnimationFrame(()=>{document.body.contains(l)&&s.render(l,l._bw_state||{})})):s.mounted&&(document.body.contains(l)?s.mounted(l,l._bw_state||{}):requestAnimationFrame(()=>{document.body.contains(l)&&s.mounted(l,l._bw_state||{})})),s.unmount&&R._unmountCallbacks.set(e,()=>{s.unmount(l,l._bw_state||{})})}else i["data-bw_id"]&&R._registerNode(l,i["data-bw_id"]);return l},R.DOM=function(e,t,r={}){if(!R._isBrowser)throw new Error("bw.DOM requires a DOM environment (document/window). Use bw.html() instead.");const o=R._el(e);if(!o)return console.error("bw.DOM: Target element not found:",e),null;const n=o._bw_state,i=o._bw_render,a=o.getAttribute("data-bw_id"),s=o._bw_subs;return delete o._bw_subs,R.cleanup(o),void 0!==n&&(o._bw_state=n),i&&(o._bw_render=i),a&&(o.setAttribute("data-bw_id",a),R._registerNode(o,a)),s&&(o._bw_subs=s),o.innerHTML="",null!=t&&(!0===t._bwComponent?t.mount(o):t.element instanceof Element?o.appendChild(t.element):Array.isArray(t)?t.forEach(e=>{null!=e&&(!0===e._bwComponent?e.mount(o):e.element instanceof Element?o.appendChild(e.element):o.appendChild(R.createDOM(e,r)))}):o.appendChild(R.createDOM(t,r))),o},R.compileProps=function(e,t={}){const r={};return Object.keys(t).forEach(t=>{Object.defineProperty(r,t,{get:()=>e._props[t],set(r){const o=e._props[t];o!==r&&(e._props[t]=r,e.onPropChange&&e.onPropChange(t,r,o))},enumerable:!0,configurable:!0})}),r},R.renderComponent=function(e,t={}){const r=R.createDOM(e,t),o={element:r,taco:e,_props:{...e.a},_state:e.o?.state||{},_children:{},get props(){return this._compiledProps||(this._compiledProps=R.compileProps(this,this._props)),this._compiledProps},$(e){return this.element.querySelectorAll(e)},$first(e){return this.element.querySelector(e)},update(e){Object.assign(this._props,e);const r={...this.taco,a:{...this.taco.a,...e}},o=R.createDOM(r,t);return this.element.replaceWith(o),this.element=o,this.taco=r,this},render(){const e=R.createDOM(this.taco,t);return this.element.replaceWith(e),this.element=e,this},onPropChange(e,t,r){this.render()},get state(){return this._state},set state(e){this._state=e,this.render()},setState(e){return Object.assign(this._state,e),this.render(),this},addChild(e,t){return this._children[e]=t,this},getChild(e){return this._children[e]},destroy(){Object.values(this._children).forEach(e=>{e&&e.destroy&&e.destroy()}),R.cleanup(this.element),this.element.remove(),this._children={},this._props={},this._state={},this._compiledProps=null}};return r._bwHandle=o,o},R.cleanup=function(e){if(!R._isBrowser||!e)return;e.querySelectorAll("[data-bw_id]").forEach(e=>{const t=e.getAttribute("data-bw_id"),r=R._unmountCallbacks.get(t);r&&(r(),R._unmountCallbacks.delete(t)),R._deregisterNode(e,t),e._bw_subs&&(e._bw_subs.forEach(function(e){e()}),delete e._bw_subs),delete e._bw_state,delete e._bw_render,delete e._bw_refs});const t=e.getAttribute("data-bw_id");if(t){const r=R._unmountCallbacks.get(t);r&&(r(),R._unmountCallbacks.delete(t)),R._deregisterNode(e,t),e._bw_subs&&(e._bw_subs.forEach(function(e){e()}),delete e._bw_subs),delete e._bw_state,delete e._bw_render,delete e._bw_refs,e._bwComponentHandle&&(e._bwComponentHandle.mounted=!1,e._bwComponentHandle.element=null,delete e._bwComponentHandle)}},R.update=function(e){var t=R._el(e);return t&&t._bw_render&&(t._bw_render(t,t._bw_state||{}),R.emit(t,"statechange",t._bw_state)),t||null},R.patch=function(e,t,r){var o=R._el(e);return o?(r?o.setAttribute(r,String(t)):Array.isArray(t)?(o.innerHTML="",t.forEach(function(e){"string"==typeof e||"number"==typeof e?o.appendChild(document.createTextNode(String(e))):e&&e.t&&o.appendChild(R.createDOM(e))})):"object"==typeof t&&null!==t&&t.t?(o.innerHTML="",o.appendChild(R.createDOM(t))):o.textContent=String(t),o):null},R.patchAll=function(e){var t={};for(var r in e)Object.prototype.hasOwnProperty.call(e,r)&&(t[r]=R.patch(r,e[r]));return t},R.emit=function(e,t,r){var o=R._el(e);o&&o.dispatchEvent(new CustomEvent("bw:"+t,{bubbles:!0,detail:r||{}}))},R.on=function(e,t,r){var o=R._el(e);return o&&o.addEventListener("bw:"+t,function(e){r(e.detail,e)}),o||null},R.pub=function(e,t){var r=R._topics[e];if(!r||0===r.length)return 0;for(var o=r.slice(),n=0,i=0;i<o.length;i++)try{o[i].handler(t),n++}catch(t){console.warn('bw.pub: subscriber error on topic "'+e+'":',t)}return n},R.sub=function(e,t,r){var o=++R._subIdCounter;R._topics[e]||(R._topics[e]=[]),R._topics[e].push({handler:t,id:o});var n=function(){var t=R._topics[e];t&&(R._topics[e]=t.filter(function(e){return e.id!==o}),0===R._topics[e].length&&delete R._topics[e])};if(r&&(r._bw_subs||(r._bw_subs=[]),r._bw_subs.push(n),!r.getAttribute("data-bw_id"))){var i="bw_sub_"+o;r.setAttribute("data-bw_id",i)}return n},R.unsub=function(e,t){var r=R._topics[e];if(!r)return 0;var o=r.length;R._topics[e]=r.filter(function(e){return e.handler!==t});var n=o-R._topics[e].length;return 0===R._topics[e].length&&delete R._topics[e],n},R._fnRegistry={},R._fnIDCounter=0,R.funcRegister=function(e,t){if("function"!=typeof e)return"";var r="string"==typeof t&&t.length>0?t:"bw_fn_"+R._fnIDCounter++;return R._fnRegistry[r]=e,r},R.funcGetById=function(e,t){return(e=String(e))in R._fnRegistry?R._fnRegistry[e]:"function"==typeof t?t:function(){console.warn('bw.funcGetById: unregistered fn "'+e+'"')}},R.funcGetDispatchStr=function(e,t){return"bw.funcGetById('"+e+"')("+(t=null!=t?String(t):"")+")"},R.funcUnregister=function(e){return e in R._fnRegistry&&(delete R._fnRegistry[e],!0)},R.funcGetRegistry=function(){var e={};for(var t in R._fnRegistry)Object.prototype.hasOwnProperty.call(R._fnRegistry,t)&&(e[t]=R._fnRegistry[t]);return e},R._parseBindings=function(e){for(var t,r=[],o=/\$\{([^}]+)\}/g;null!==(t=o.exec(e));)r.push({start:t.index,end:t.index+t[0].length,expr:t[1].trim()});return r},R._evaluatePath=function(e,t){for(var r=t.split("."),o=e,n=0;n<r.length;n++){if(null==o)return"";o=o[r[n]]}return null==o?"":o},R._compiledExprs={},R._resolveTemplate=function(e,t,r){if("string"!=typeof e||e.indexOf("${")<0)return e;var o=R._parseBindings(e);if(0===o.length)return e;for(var n="",i=0,a=0;a<o.length;a++){var s,l=o[a];if(n+=e.slice(i,l.start),r){if(!R._compiledExprs[l.expr])try{R._compiledExprs[l.expr]=new Function("state","with(state){return ("+l.expr+");}")}catch(e){R._compiledExprs[l.expr]=function(){return""}}try{s=R._compiledExprs[l.expr](t)}catch(e){s=""}}else s=R._evaluatePath(t,l.expr);n+=null==s?"":String(s),i=l.end}return n+=e.slice(i)},R._extractDeps=function(e,t){for(var r=[],o=0;o<t.length;o++){var n=t[o];(new RegExp("(?:^|[^\\w$.])"+n.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")+"(?:[^\\w$]|$)").test(e)||e===n||0===e.indexOf(n+"."))&&r.push(n)}return r},R._dirtyComponents=[],R._flushScheduled=!1,R._scheduleFlush=function(){R._flushScheduled||(R._flushScheduled=!0,"undefined"!=typeof Promise?Promise.resolve().then(R._doFlush):setTimeout(R._doFlush,0))},R._doFlush=function(){R._flushScheduled=!1;var e=R._dirtyComponents.slice();R._dirtyComponents=[];for(var t={},r=0;r<e.length;r++){var o=e[r];t[o._bwId]||(t[o._bwId]=!0,o._flush())}},R.flush=function(){R._doFlush()},U.prototype.get=function(e){return R._evaluatePath(this._state,e)},U.prototype.set=function(e,t,r){for(var o=e.split("."),n=this._state,i=0;i<o.length-1;i++)null!=n[o[i]]&&"object"==typeof n[o[i]]||(n[o[i]]={}),n=n[o[i]];n[o[o.length-1]]=t,this._dirtyKeys[o[0]]=!0,this.mounted&&(r&&r.sync?this._flush():this._scheduleDirty())},U.prototype.getState=function(){var e={};for(var t in this._state)Object.prototype.hasOwnProperty.call(this._state,t)&&(e[t]=this._state[t]);return e},U.prototype.setState=function(e,t){for(var r in e)Object.prototype.hasOwnProperty.call(e,r)&&(this._state[r]=e[r],this._dirtyKeys[r]=!0);this.mounted&&(t&&t.sync?this._flush():this._scheduleDirty())},U.prototype.push=function(e,t){var r=this.get(e),o=Array.isArray(r)?r.slice():[];o.push(t),this.set(e,o)},U.prototype.splice=function(e,t,r){var o=this.get(e),n=Array.isArray(o)?o.slice():[],i=[t,r].concat(Array.prototype.slice.call(arguments,3));Array.prototype.splice.apply(n,i),this.set(e,n)},U.prototype._scheduleDirty=function(){this._scheduled||(this._scheduled=!0,R._dirtyComponents.push(this),R._scheduleFlush())},U.prototype._compileBindings=function(){this._bindings=[],this._refCounter=0;var e=Object.keys(this._state),t=this;!function r(o,n){if(null==o||"object"!=typeof o||!o.t)return o;if("string"==typeof o.c&&o.c.indexOf("${")>=0){for(var i="bw_ref_"+t._refCounter++,a=R._parseBindings(o.c),s=[],l=0;l<a.length;l++)s=s.concat(R._extractDeps(a[l].expr,e));t._bindings.push({expr:o.c,type:"content",refId:i,deps:s,template:o.c}),o.a||(o.a={}),o.a["data-bw_ref"]=i}if(o.a)for(var c in o.a)if(Object.prototype.hasOwnProperty.call(o.a,c)&&"data-bw_ref"!==c){var d=o.a[c];if("string"==typeof d&&d.indexOf("${")>=0){for(var b="bw_ref_"+t._refCounter++,_=R._parseBindings(d),p=[],m=0;m<_.length;m++)p=p.concat(R._extractDeps(_[m].expr,e));t._bindings.push({expr:d,type:"attribute",attrName:c,refId:b,deps:p,template:d}),o.a||(o.a={}),o.a["data-bw_ref"]=o.a["data-bw_ref"]||b,o.a["data-bw_ref"]!==b&&(o.a["data-bw_ref_"+c]=b)}}if(Array.isArray(o.c))for(var f=0;f<o.c.length;f++){if(o.c[f]&&"object"==typeof o.c[f]&&o.c[f].t&&r(o.c[f],n.concat(f)),o.c[f]&&o.c[f]._bwWhen){var u="bw_ref_"+t._refCounter++,h=R._extractDeps(o.c[f].expr.replace(/^\$\{|\}$/g,""),e);t._bindings.push({expr:o.c[f].expr,type:"structural",subtype:"when",refId:u,deps:h,branches:o.c[f].branches,index:f,parentPath:n}),o.c[f]._refId=u}if(o.c[f]&&o.c[f]._bwEach){var w="bw_ref_"+t._refCounter++,g=R._extractDeps(o.c[f].expr.replace(/^\$\{|\}$/g,""),e);t._bindings.push({expr:o.c[f].expr,type:"structural",subtype:"each",refId:w,deps:g,factory:o.c[f].factory,index:f,parentPath:n}),o.c[f]._refId=w}}else o.c&&"object"==typeof o.c&&o.c.t&&r(o.c,n.concat(0));return o}(this.taco,[])},U.prototype._collectRefs=function(){if(this._bw_refs={},this.element){for(var e=this.element.querySelectorAll("[data-bw_ref]"),t=0;t<e.length;t++)this._bw_refs[e[t].getAttribute("data-bw_ref")]=e[t];var r=this.element.getAttribute&&this.element.getAttribute("data-bw_ref");r&&(this._bw_refs[r]=this.element)}},U.prototype.mount=function(e){this._hooks.willMount&&this._hooks.willMount(this),this._originalTaco||(this._originalTaco=this.taco),this.taco=this._deepCloneTaco(this._originalTaco),this._compileBindings(),this._prepareTaco(this.taco);var t=this;for(var r in this._actions)if(Object.prototype.hasOwnProperty.call(this._actions,r)){var o=this._bwId+"_"+r;(function(e){R.funcRegister(function(r){t._actions[e](t,r)},o)})(r),this._registeredActions.push(o)}this._wireActions(this.taco);var n=this._tacoForDOM(this.taco);this.element=R.createDOM(n),this.element._bwComponentHandle=this,this.element.setAttribute("data-bw_comp_id",this._bwId),e.appendChild(this.element),this._collectRefs(),this._resolveAndApplyAll(),this.mounted=!0,this._hooks.mounted&&(2===this._hooks.mounted.length?this._hooks.mounted(this.element,this.getState()):this._hooks.mounted(this))},U.prototype._prepareTaco=function(e){if(e&&"object"==typeof e)if(Array.isArray(e.c))for(var t=e.c.length-1;t>=0;t--){var r=e.c[t];if(r&&r._bwWhen){var o,n=r.expr.replace(/^\$\{|\}$/g,"");if(this._compile)try{o=new Function("state","with(state){return ("+n+");}")(this._state)}catch(e){o=!1}else o=R._evaluatePath(this._state,n);var i=o?r.branches[0]:r.branches[1]||null;e.c[t]=i?{t:"span",a:{"data-bw_when":r._refId,style:"display:contents"},c:i}:{t:"span",a:{"data-bw_when":r._refId,style:"display:contents"},c:""}}if(r&&r._bwEach){var a=r.expr.replace(/^\$\{|\}$/g,""),s=R._evaluatePath(this._state,a),l=[];if(Array.isArray(s))for(var c=0;c<s.length;c++)l.push(r.factory(s[c],c));e.c[t]={t:"span",a:{"data-bw_each":r._refId,style:"display:contents"},c:l}}e.c[t]&&"object"==typeof e.c[t]&&e.c[t].t&&this._prepareTaco(e.c[t])}else e.c&&"object"==typeof e.c&&e.c.t&&this._prepareTaco(e.c)},U.prototype._wireActions=function(e){if(e&&"object"==typeof e&&e.t){if(e.a)for(var t in e.a)if(Object.prototype.hasOwnProperty.call(e.a,t)&&t.startsWith("on")&&"string"==typeof e.a[t]){var r=e.a[t];if(r in this._actions)(function(r){e.a[t]=function(e){R.funcGetById(r)(e)}})(this._bwId+"_"+r)}if(Array.isArray(e.c))for(var o=0;o<e.c.length;o++)this._wireActions(e.c[o]);else e.c&&"object"==typeof e.c&&e.c.t&&this._wireActions(e.c)}},U.prototype._deepCloneTaco=function(e){if(null==e)return e;if(e._bwWhen)return{_bwWhen:!0,expr:e.expr,branches:[this._deepCloneTaco(e.branches[0]),e.branches[1]?this._deepCloneTaco(e.branches[1]):null],_refId:e._refId};if(e._bwEach)return{_bwEach:!0,expr:e.expr,factory:e.factory,_refId:e._refId};if("object"!=typeof e||!e.t)return e;var t={t:e.t};if(e.a)for(var r in t.a={},e.a)Object.prototype.hasOwnProperty.call(e.a,r)&&(t.a[r]=e.a[r]);return null!=e.c&&(Array.isArray(e.c)?t.c=e.c.map(function(e){return this._deepCloneTaco(e)}.bind(this)):"object"==typeof e.c?t.c=this._deepCloneTaco(e.c):t.c=e.c),e.o&&(t.o=e.o),t},U.prototype._tacoForDOM=function(e){if(!e||"object"!=typeof e||!e.t)return e;var t={t:e.t};return e.a&&(t.a=e.a),null!=e.c&&(Array.isArray(e.c)?t.c=e.c.map(function(e){return this._tacoForDOM(e)}.bind(this)):"object"==typeof e.c&&e.c.t?t.c=this._tacoForDOM(e.c):t.c=e.c),t},U.prototype.unmount=function(){if(this.mounted){this._hooks.unmount&&this._hooks.unmount(this);for(var e=0;e<this._eventListeners.length;e++){var t=this._eventListeners[e];this.element&&this.element.removeEventListener(t.event,t.handler)}this._eventListeners=[];for(var r=0;r<this._subs.length;r++)this._subs[r]();this._subs=[],this.element&&this.element.parentNode&&this.element.parentNode.removeChild(this.element),this.mounted=!1}},U.prototype.destroy=function(){this._hooks.willDestroy&&this._hooks.willDestroy(this),this.unmount();for(var e=0;e<this._registeredActions.length;e++)R.funcUnregister(this._registeredActions[e]);this._registeredActions=[],this._state={},this._bindings=[],this._bw_refs={},this._prevValues={},this._dirtyKeys={},this.element&&(delete this.element._bwComponentHandle,this.element=null)},U.prototype._flush=function(){this._scheduled=!1;var e=Object.keys(this._dirtyKeys);if(this._dirtyKeys={},0!==e.length&&this.mounted){this._hooks.willUpdate&&this._hooks.willUpdate(this,e);for(var t=!1,r=0;r<this._bindings.length;r++){var o=this._bindings[r];if("structural"===o.type){for(var n=0;n<o.deps.length;n++)if(e.indexOf(o.deps[n])>=0){t=!0;break}if(t)break}}if(t)this._render();else{var i=this._resolveBindings(e);this._applyPatches(i)}this._hooks.onUpdate&&this._hooks.onUpdate(this,e)}},U.prototype._resolveBindings=function(e){for(var t=[],r=0;r<this._bindings.length;r++){var o=this._bindings[r];if("structural"!==o.type){for(var n=!1,i=0;i<o.deps.length;i++)if(e.indexOf(o.deps[i])>=0){n=!0;break}if(n){var a=R._resolveTemplate(o.template,this._state,this._compile),s=o.refId+"_"+(o.attrName||"content");this._prevValues[s]!==a&&(this._prevValues[s]=a,t.push({refId:o.refId,type:o.type,attrName:o.attrName,value:a}))}}}return t},U.prototype._applyPatches=function(e){for(var t=0;t<e.length;t++){var r=e[t],o=this._bw_refs[r.refId];o&&("content"===r.type?o.textContent=r.value:"attribute"===r.type&&("class"===r.attrName?o.className=r.value:o.setAttribute(r.attrName,r.value)))}},U.prototype._resolveAndApplyAll=function(){for(var e=[],t=0;t<this._bindings.length;t++){var r=this._bindings[t];if("structural"!==r.type){var o=R._resolveTemplate(r.template,this._state,this._compile),n=r.refId+"_"+(r.attrName||"content");this._prevValues[n]=o,e.push({refId:r.refId,type:r.type,attrName:r.attrName,value:o})}}this._applyPatches(e)},U.prototype._render=function(){if(this.element&&this.element.parentNode){var e=this.element.parentNode,t=this.element.nextSibling;e.removeChild(this.element),this.taco=this._deepCloneTaco(this._originalTaco||this.taco),this._compileBindings(),this._prepareTaco(this.taco),this._wireActions(this.taco);var r=this._tacoForDOM(this.taco);this.element=R.createDOM(r),this.element._bwComponentHandle=this,this.element.setAttribute("data-bw_comp_id",this._bwId),t?e.insertBefore(this.element,t):e.appendChild(this.element),this._collectRefs(),this._resolveAndApplyAll()}},U.prototype.on=function(e,t){this.element&&this.element.addEventListener(e,t),this._eventListeners.push({event:e,handler:t})},U.prototype.off=function(e,t){this.element&&this.element.removeEventListener(e,t),this._eventListeners=this._eventListeners.filter(function(r){return!(r.event===e&&r.handler===t)})},U.prototype.sub=function(e,t){var r=R.sub(e,t);return this._subs.push(r),r},U.prototype.action=function(e){var t=this._actions[e];if(t){var r=[this].concat(Array.prototype.slice.call(arguments,1));return t.apply(null,r)}console.warn('ComponentHandle.action: unknown action "'+e+'"')},U.prototype.select=function(e){return this.element?this.element.querySelector(e):null},U.prototype.selectAll=function(e){return this.element?Array.prototype.slice.call(this.element.querySelectorAll(e)):[]},R._ComponentHandle=U,R.when=function(e,t,r){return{_bwWhen:!0,expr:e,branches:[t,r||null]}},R.each=function(e,t){return{_bwEach:!0,expr:e,factory:t}},R.component=function(e){return new U(e)},R.compile=function(e){var t=[];return function e(r){if(r&&"object"==typeof r){if("string"==typeof r.c&&r.c.indexOf("${")>=0)for(var o=R._parseBindings(r.c),n=0;n<o.length;n++)try{t.push({expr:o[n].expr,fn:new Function("state","with(state){return ("+o[n].expr+");}")})}catch(e){t.push({expr:o[n].expr,fn:function(){return""}})}if(r.a)for(var i in r.a)if(Object.prototype.hasOwnProperty.call(r.a,i)){var a=r.a[i];if("string"==typeof a&&a.indexOf("${")>=0)for(var s=R._parseBindings(a),l=0;l<s.length;l++)try{t.push({expr:s[l].expr,fn:new Function("state","with(state){return ("+s[l].expr+");}")})}catch(e){t.push({expr:s[l].expr,fn:function(){return""}})}}if(Array.isArray(r.c))for(var c=0;c<r.c.length;c++)e(r.c[c]);else r.c&&"object"==typeof r.c&&r.c.t&&e(r.c)}}(e),function(r){var o=new U(e);if(o._compile=!0,o._precompiledBindings=t,r)for(var n in r)Object.prototype.hasOwnProperty.call(r,n)&&(o._state[n]=r[n]);return o}},R.css=function(e,t={}){const{minify:r=!1,pretty:o=!r}=t;if("string"==typeof e)return e;let n="";const i=o?"  ":"",a=o?"\n":"",s=o?" ":"";return Array.isArray(e)?n=e.map(e=>R.css(e,t)).join(a):"object"==typeof e&&Object.entries(e).forEach(([e,r])=>{if("object"==typeof r&&!Array.isArray(r)){if("@"===e.charAt(0)){const o=R.css(r,t);return void(o&&(n+=`${e}${s}{${a}${o}${a}}${a}`))}const o=Object.entries(r).filter(([,e])=>null!=e).map(([e,t])=>{const r=e.replace(/[A-Z]/g,e=>"-"+e.toLowerCase());return`${i}${r}:${s}${t};`}).join(a);o&&(n+=`${e}${s}{${a}${o}${a}}${a}`)}}),n.trim()},R.injectCSS=function(e,t={}){if(!R._isBrowser)return console.warn("bw.injectCSS requires a DOM environment"),null;const{id:r="bw_styles",append:o=!0}=t;let n=document.getElementById(r);n||(n=document.createElement("style"),n.id=r,n.type="text/css",document.head.appendChild(n));const i="string"==typeof e?e:R.css(e,t);return o&&n.textContent?n.textContent+="\n"+i:n.textContent=i,n},R.s=function(){for(var e={},t=0;t<arguments.length;t++){var r=arguments[t];r&&"object"==typeof r&&Object.assign(e,r)}return e},R.u={flex:{display:"flex"},flexCol:{display:"flex",flexDirection:"column"},flexRow:{display:"flex",flexDirection:"row"},flexWrap:{display:"flex",flexWrap:"wrap"},block:{display:"block"},inline:{display:"inline"},hidden:{display:"none"},justifyCenter:{justifyContent:"center"},justifyBetween:{justifyContent:"space-between"},justifyEnd:{justifyContent:"flex-end"},alignCenter:{alignItems:"center"},alignStart:{alignItems:"flex-start"},alignEnd:{alignItems:"flex-end"},gap1:{gap:"0.25rem"},gap2:{gap:"0.5rem"},gap3:{gap:"0.75rem"},gap4:{gap:"1rem"},gap6:{gap:"1.5rem"},gap8:{gap:"2rem"},p0:{padding:"0"},p1:{padding:"0.25rem"},p2:{padding:"0.5rem"},p3:{padding:"0.75rem"},p4:{padding:"1rem"},p6:{padding:"1.5rem"},p8:{padding:"2rem"},px4:{paddingLeft:"1rem",paddingRight:"1rem"},py2:{paddingTop:"0.5rem",paddingBottom:"0.5rem"},py4:{paddingTop:"1rem",paddingBottom:"1rem"},m0:{margin:"0"},m4:{margin:"1rem"},mt2:{marginTop:"0.5rem"},mt4:{marginTop:"1rem"},mb2:{marginBottom:"0.5rem"},mb4:{marginBottom:"1rem"},mx_auto:{marginLeft:"auto",marginRight:"auto"},textSm:{fontSize:"0.875rem"},textBase:{fontSize:"1rem"},textLg:{fontSize:"1.125rem"},textXl:{fontSize:"1.25rem"},text2xl:{fontSize:"1.5rem"},text3xl:{fontSize:"1.875rem"},bold:{fontWeight:"700"},semibold:{fontWeight:"600"},italic:{fontStyle:"italic"},textCenter:{textAlign:"center"},textRight:{textAlign:"right"},bgWhite:{background:"#ffffff"},bgTeal:{background:"#006666",color:"#ffffff"},textWhite:{color:"#ffffff"},textTeal:{color:"#006666"},textMuted:{color:"#888"},rounded:{borderRadius:"0.375rem"},roundedLg:{borderRadius:"0.5rem"},roundedFull:{borderRadius:"9999px"},border:{border:"1px solid #d8d8d8"},wFull:{width:"100%"},hFull:{height:"100%"},transition:{transition:"all 0.2s ease"}},R.responsive=function(e,t){var r={sm:"576px",md:"768px",lg:"992px",xl:"1200px"},o=[];return Object.keys(t).forEach(function(n){var i={};"base"===n?(i[e]=t[n],o.push(R.css(i))):r[n]&&(i[e]=t[n],o.push("@media (min-width: "+r[n]+") {\n"+R.css(i)+"\n}"))}),o.join("\n")},R.mapScale=L,R.clip=I,R._isBrowser&&(R.$=function(e){return e?Array.isArray(e)?e:e.nodeType?[e]:void 0!==e.length&&"string"!=typeof e?Array.from(e):"string"==typeof e?Array.from(document.querySelectorAll(e)):[]:[]},R.$.one=function(e){return R.$(e)[0]||null}),R.loadDefaultStyles=function(e={}){const{minify:t=!0,palette:r}=e;if(R._isBrowser){var o=R.css(T());R.injectCSS(o,{id:"bw_structural",append:!1,minify:t})}var n=Object.assign({},C,r||{});return R.generateTheme("",Object.assign({},n,{inject:!0}))},R.getTheme=function(){return"undefined"!=typeof console&&console.warn&&console.warn("bw.getTheme() is deprecated. Use bw.generateTheme() instead."),JSON.parse(JSON.stringify(z))},R.setTheme=function(e,t={}){"undefined"!=typeof console&&console.warn&&console.warn("bw.setTheme() is deprecated. Use bw.generateTheme() instead.");const{inject:r=!0}=t;if(E(e),r&&R._isBrowser&&e.colors){const t=document.documentElement;for(const[r,o]of Object.entries(e.colors))t.style.setProperty("--bw-"+r,o)}return R.getTheme()},R.generateTheme=function(e,t){if(!t||!t.primary||!t.secondary)throw new Error("bw.generateTheme requires config.primary and config.secondary");var r=Object.assign({},C,t);t.tertiary||(r.tertiary=r.primary);var o=h(r),n=function(e){var t=e&&e.spacing||"normal",r=e&&e.radius||"md",o=e&&e.fontSize||1,n=e&&e.typeRatio||"normal",i="string"==typeof n?y[n]||y.normal:n,a=e&&e.elevation||"md",s=e&&e.motion||"standard";return{spacing:"string"==typeof t?w[t]||w.normal:t,radius:"string"==typeof r?g[r]||g.md:r,fontSize:o,typeScale:v(16,i),elevation:"string"==typeof a?x[a]||x.md:a,motion:"string"==typeof s?k[s]||k.standard:s}}(r),i=A(e,o,n),a=R.css(i),s=h(u(r)),l=function(e,t,r){var o=A("",t,r),n=e?"."+e+".bw_theme_alt":".bw_theme_alt",i={};for(var a in o)if(o.hasOwnProperty(a))if("@"===a.charAt(0)){var s=o[a],l={};for(var c in s)s.hasOwnProperty(c)&&(l[n+" "+c]=s[c]);i[a]=l}else{for(var d=a.split(","),b=[],_=0;_<d.length;_++){var p=d[_].trim();"body"===p||p.indexOf("body"),b.push(n+" "+p)}i[b.join(", ")]=o[a]}return i[n+" body, :root"+n+" body"]={color:t.dark.base,"background-color":t.light.base},i}(e,s,n),c=R.css(l),d=f(r);if(!1!==t.inject&&R._isBrowser){var b=e?e.replace(/-/g,"_"):"",_=b?"bw_theme_"+b:"bw_theme_default";R.injectCSS(a,{id:_,append:!1});var p=b?"bw_theme_"+b+"_alt":"bw_theme_default_alt";R.injectCSS(c,{id:p,append:!1})}e||(R.u.bgTeal={background:o.primary.base,color:o.primary.textOn},R.u.textTeal={color:o.primary.base},R.u.bgWhite={background:"#ffffff"},R.u.textWhite={color:"#ffffff"});var m={css:a,palette:o,name:e,isLightPrimary:d,alternate:{css:c,palette:s}};return R._activeTheme=m,R._activeThemeMode="primary",m},R.applyTheme=function(e){if(!R._isBrowser)return e||"primary";var t,r=document.documentElement,o=!R._activeTheme||R._activeTheme.isLightPrimary;return(t="primary"!==e&&("alternate"===e||("light"===e?!o:"dark"===e&&o)))?r.classList.add("bw_theme_alt"):r.classList.remove("bw_theme_alt"),R._activeThemeMode=t?"alternate":"primary",R._activeThemeMode},R.toggleTheme=function(){var e=R._activeThemeMode||"primary";return R.applyTheme("primary"===e?"alternate":"primary")},R.hexToHsl=a,R.hslToHex=s,R.adjustLightness=l,R.mixColor=c,R.relativeLuminance=d,R.textOnColor=b,R.deriveShades=p,R.derivePalette=h,R.harmonize=_,R.deriveAlternateSeed=m,R.deriveAlternateConfig=u,R.isLightPalette=f,R.SPACING_PRESETS=w,R.RADIUS_PRESETS=g,R.TYPE_RATIO_PRESETS=y,R.ELEVATION_PRESETS=x,R.MOTION_PRESETS=k,R.generateTypeScale=v,R.DEFAULT_PALETTE_CONFIG=C,R.THEME_PRESETS={teal:{primary:"#006666",secondary:"#6c757d",tertiary:"#006666",label:"Teal",desc:"The signature bitwrench palette — professional teal and neutral gray."},ocean:{primary:"#0077b6",secondary:"#90e0ef",tertiary:"#00b4d8",label:"Ocean",desc:"Cool blues and teals for a calm, professional look."},sunset:{primary:"#e76f51",secondary:"#264653",tertiary:"#e9c46a",label:"Sunset",desc:"Warm oranges and deep earth tones for a bold feel."},forest:{primary:"#2d6a4f",secondary:"#95d5b2",tertiary:"#52b788",label:"Forest",desc:"Natural greens for an organic, earthy vibe."},slate:{primary:"#343a40",secondary:"#adb5bd",tertiary:"#6c757d",label:"Slate",desc:"Elegant grays for a minimal, modern interface."},rose:{primary:"#e11d48",secondary:"#fda4af",tertiary:"#fb7185",label:"Rose",desc:"Vibrant pinks and reds for a bold, energetic design."},indigo:{primary:"#4f46e5",secondary:"#a5b4fc",tertiary:"#818cf8",label:"Indigo",desc:"Deep purples and soft lavenders for a creative palette."},amber:{primary:"#d97706",secondary:"#fbbf24",tertiary:"#f59e0b",label:"Amber",desc:"Warm golds and yellows for a sunny, welcoming feel."},emerald:{primary:"#059669",secondary:"#6ee7b7",tertiary:"#34d399",label:"Emerald",desc:"Bright greens and mints for a fresh, modern look."},nord:{primary:"#5e81ac",secondary:"#88c0d0",tertiary:"#81a1c1",label:"Nord",desc:"Muted arctic blues inspired by the Nord color scheme."},coral:{primary:"#ef6461",secondary:"#4a7c7e",tertiary:"#e8a87c",label:"Coral",desc:"Warm coral and teal for a balanced, approachable design."},midnight:{primary:"#1e3a5f",secondary:"#7c8db5",tertiary:"#3d5a80",label:"Midnight",desc:"Deep navy and steel blue for a sophisticated, authoritative feel."}},R.choice=function(e,t,r){const o=e in t?t[e]:r;return"function"===$(o)?o(e):o},R.arrayUniq=N,R.arrayBinA=function(e,t){return"array"!==$(e)||"array"!==$(t)?[]:N(e.filter(e=>-1!==t.indexOf(e)))},R.arrayBNotInA=function(e,t){return"array"!==$(e)||"array"!==$(t)?[]:N(t.filter(t=>e.indexOf(t)<0))},R.colorInterp=function(e,t,r,n,i){return function(e,t,r,o,n,i){let a=Array.isArray(o)?o:["#000","#fff"];if(a=0===a.length?["#000","#fff"]:a,1===a.length)return a[0];a=a.map(e=>i(e));const s=L(e,t,r,0,a.length-1,{clip:!0,expScale:n}),l=I(Math.floor(s),0,a.length-2),c=s-l,d=e=>L(c,0,1,a[l][e],a[l+1][e],{clip:!0});return[d(0),d(1),d(2),d(3),"rgb"]}(e,t,r,n,i,o)},R.colorHslToRgb=i,R.colorRgbToHsl=n,R.colorParse=o,R.setCookie=function(e,t,r,o={}){if(!R._isBrowser)return;const n=new Date;n.setTime(n.getTime()+24*r*60*60*1e3);let i=`${e}=${t}; expires=${n.toUTCString()}`;o.path&&(i+=`; path=${o.path}`),o.domain&&(i+=`; domain=${o.domain}`),o.secure&&(i+="; secure"),o.sameSite&&(i+=`; samesite=${o.sameSite}`),document.cookie=i},R.getCookie=function(e,t){if(!R._isBrowser)return t;const r=e+"=",o=document.cookie.split(";");for(let e=0;e<o.length;e++){let t=o[e];for(;" "===t.charAt(0);)t=t.substring(1);if(0===t.indexOf(r))return t.substring(r.length,t.length)}return t},R.getURLParam=function(e,t){if(!R._isBrowser||"object"!=typeof window)return t;try{const r=new URLSearchParams(window.location.search);if(!e){const e={};for(const[t,o]of r)e[t]=o||!0;return e}return r.has(e)?r.get(e)||!0:t}catch(e){return t}},R.htmlTable=function(e,t={}){if(console.warn("bw.htmlTable() is deprecated. Use bw.makeTableFromArray() for TACO output or bw.makeTable() for object-array data."),"array"!==R.typeOf(e)||e.length<1)return"";const r={useFirstRowAsHeaders:!0,caption:null,atr:{class:"table"},thead_atr:{},th_atr:{},tbody_atr:{},tr_atr:{},td_atr:{}};Object.assign(r,t);let o=`<table${R._attrsToStr(r.atr)}>`;r.caption&&(o+=`<caption>${R.escapeHTML(r.caption)}</caption>`);let n=0;if(r.useFirstRowAsHeaders&&e.length>0&&(o+=`<thead${R._attrsToStr(r.thead_atr)}>`,o+=`<tr${R._attrsToStr(r.tr_atr)}>`,e[0].forEach(e=>{o+=`<th${R._attrsToStr(r.th_atr)}>${R.escapeHTML(String(e))}</th>`}),o+="</tr></thead>",n=1),e.length>n){o+=`<tbody${R._attrsToStr(r.tbody_atr)}>`;for(let t=n;t<e.length;t++)o+=`<tr${R._attrsToStr(r.tr_atr)}>`,e[t].forEach(e=>{o+=`<td${R._attrsToStr(r.td_atr)}>${R.escapeHTML(String(e))}</td>`}),o+="</tr>";o+="</tbody>"}return o+="</table>",o},R._attrsToStr=function(e){if(!e||"object"!=typeof e)return"";let t="";for(const[r,o]of Object.entries(e))null!=o&&!1!==o&&(t+=!0===o?` ${r}`:` ${r}="${R.escapeHTML(String(o))}"`);return t},R.htmlTabs=function(e,t={}){if(console.warn("bw.htmlTabs() is deprecated. Use bw.makeTabs() instead."),"array"!==R.typeOf(e)||e.length<1)return"";const r={atr:{class:"bw_tab_container"},tab_atr:{class:"bw_tab_item_list"},tabc_atr:{class:"bw_tab_content_list"}};Object.assign(r,t);const o=e.map((e,t)=>({t:"li",a:{class:0===t?"bw_tab_item bw_tab_active":"bw_tab_item",onclick:"bw.selectTabContent(this)"},c:e[0]})),n=e.map((e,t)=>({t:"div",a:{class:0===t?"bw_tab_content bw_show":"bw_tab_content"},c:e[1]}));return R.html({t:"div",a:r.atr,c:[{t:"ul",a:r.tab_atr,c:o},{t:"div",a:r.tabc_atr,c:n}]})},R.selectTabContent=function(e){if(console.warn("bw.selectTabContent() is deprecated. Use bw.makeTabs() instead."),!R._isBrowser||!e)return;const t=e.closest(".bw_tab_container");if(!t)return;t.querySelectorAll(".bw_tab_item").forEach(e=>{e.classList.remove("bw_tab_active")}),e.classList.add("bw_tab_active");const r=Array.from(e.parentElement.children).indexOf(e);t.querySelectorAll(".bw_tab_content").forEach(e=>{e.classList.remove("bw_show")});const o=t.querySelectorAll(".bw_tab_content");o[r]&&o[r].classList.add("bw_show")},R.loremIpsum=function(e,t,r=!0){const o="Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. ";"number"!=typeof e&&(e=Math.floor(125*Math.random())+25),void 0===t&&(t=Math.floor(446*Math.random())),t%=446;let n=0;for(;" "===o[t]||/[.,:;!?]/.test(o[t]);)if(t=(t+1)%446,n++,n>=446){t=0,n=0;break}let i=o.substring(t)+o.substring(0,t),a="",s=e+n;for(;s>0;)a+=s<i.length?i.substring(0,s):i,s-=i.length;if(a.length>e&&(a=a.substring(0,e))," "===a[a.length-1]&&(a=a.substring(0,a.length-1)+"."),r){let e=a[0].toUpperCase();e=/[A-Z]/.test(e)?e:"L",a=e+a.substring(1)}return a},R.multiArray=function(e,t){t="number"==typeof t?[t]:t;const r=o=>{if(o>=t.length)return"function"===$(e)?e():e;const n=[];for(let e=0;e<t[o];e++)n[e]=r(o+1);return n};return r(0)},R.naturalCompare=function(e,t){if(isFinite(e)&&isFinite(t))return Math.sign(e-t);const r=String(e).toLowerCase(),o=String(t).toLowerCase();if(r===o)return e>t?1:0;if(!/\d/.test(r)||!/\d/.test(o))return r>o?1:-1;const n=r.match(/(\d+|\D+)/g)||[],i=o.match(/(\d+|\D+)/g)||[],a=Math.min(n.length,i.length);for(let e=0;e<a;e++){const t=n[e],r=i[e];if(t!==r){if(/^\d+$/.test(t)&&/^\d+$/.test(r)){let e=t,o=r;return"0"===t[0]&&(e="0."+t),"0"===r[0]&&(o="0."+r),parseFloat(e)-parseFloat(o)}return t>r?1:-1}}return n.length-i.length},R.setIntervalX=function(e,t,r){let o=0;const n=setInterval(function(){e(o),++o>=r&&clearInterval(n)},t);return n},R.repeatUntil=function(e,t,r,o=250,n=10,i){if("function"!=typeof e)return"err";let a=0;const s=setInterval(function(){const o=e();a++,o?(clearInterval(s),t&&t(o),i&&i(!0,a)):a>=n?(clearInterval(s),r&&r(),i&&i(!1,a)):r&&r()},o);return s},R.saveClientFile=function(e,t){if(R.isNodeJS())R._getFs().then(function(r){r?r.writeFile(e,t,function(e){e&&console.error("Error saving file:",e)}):console.error("bw.saveClientFile: fs module not available")});else{const r=new Blob([t],{type:"application/octet-stream"}),o=window.URL.createObjectURL(r),n=R.createDOM({t:"a",a:{href:o,download:e,style:"display: none"}});document.body.appendChild(n),n.click(),window.URL.revokeObjectURL(o),document.body.removeChild(n)}},R.saveClientJSON=function(e,t){R.saveClientFile(e,JSON.stringify(t,null,2))},R.loadClientFile=function(e,t,r){var o={parser:"raw"};r&&r.parser&&(o.parser=r.parser);var n="JSON"===o.parser?JSON.parse:function(e){return e};if(R.isNodeJS())R._getFs().then(function(r){r?r.readFile(e,"utf8",function(e,r){if(e)t(null,e);else try{t(n(r),null)}catch(e){t(null,e)}}):t(null,new Error("fs module not available"))});else{var i=new XMLHttpRequest;i.open("GET",e,!0),i.onreadystatechange=function(){if(4===i.readyState)if(i.status>=200&&i.status<300)try{t(n(i.responseText),null)}catch(e){t(null,e)}else t(null,new Error("HTTP "+i.status+": "+e))},i.send(null)}return"BW_OK"},R.loadClientJSON=function(e,t){return R.loadClientFile(e,t,{parser:"JSON"})},R.loadLocalFile=function(e,t){var r={parser:"raw",accept:""};t&&(t.parser&&(r.parser=t.parser),t.accept&&(r.accept=t.accept));var o="JSON"===r.parser?JSON.parse:function(e){return e};if(R.isNodeJS())e(null,"",new Error("bw.loadLocalFile is browser-only. Use bw.loadClientFile() in Node."));else{var n=R.createDOM({t:"input",a:{type:"file",accept:r.accept,style:"display: none"}});n.addEventListener("change",function(){var t=n.files[0];if(t){var r=new FileReader;r.onload=function(r){try{e(o(r.target.result),t.name,null)}catch(r){e(null,t.name,r)}},r.onerror=function(){e(null,t.name,r.error)},r.readAsText(t),n.remove()}else e(null,"",new Error("No file selected"))}),document.body.appendChild(n),n.click()}},R.loadLocalJSON=function(e){R.loadLocalFile(e,{parser:"JSON",accept:".json"})},R.copyToClipboard=function(e){return navigator.clipboard&&navigator.clipboard.writeText?navigator.clipboard.writeText(e):new Promise((t,r)=>{const o=R.createDOM({t:"textarea",a:{value:e,style:{position:"fixed",top:"-999px",left:"-999px",width:"2em",height:"2em",padding:0,border:"none",outline:"none",boxShadow:"none",background:"transparent"}}});document.body.appendChild(o),o.focus(),o.select();try{const e=document.execCommand("copy");document.body.removeChild(o),e?t():r(new Error("Copy command failed"))}catch(e){document.body.removeChild(o),r(e)}})},R.makeTable=function(e){const{data:t=[],columns:r,className:o="",striped:n=!1,hover:i=!1,sortable:a=!0,onSort:s,sortColumn:l,sortDirection:c="asc"}=e;let d="bw_table";n&&(d+=" bw_table_striped"),i&&(d+=" bw_table_hover"),o&&(d+=" "+o),d=d.trim();const b=r||(t.length>0?Object.keys(t[0]).map(e=>({key:e,label:e})):[]);let _=l||null,p=c,m=[...t];_&&m.sort((e,t)=>{const r=e[_],o=t[_];if("number"==typeof r&&"number"==typeof o)return"asc"===p?r-o:o-r;const n=String(r||"").toLowerCase(),i=String(o||"").toLowerCase();return"asc"===p?n.localeCompare(i):i.localeCompare(n)});return{t:"table",a:{class:d},c:[{t:"thead",c:{t:"tr",c:b.map(e=>({t:"th",a:a?{style:{cursor:"pointer",userSelect:"none"},onclick:()=>{return t=e.key,void(a&&(_===t?p="asc"===p?"desc":"asc":(_=t,p="asc"),s&&s(t,p)));var t}}:{},c:[e.label,a&&_===e.key&&{t:"span",a:{style:{marginLeft:"5px"}},c:"asc"===p?"▲":"▼"}].filter(Boolean)}))}},{t:"tbody",c:m.map(e=>({t:"tr",c:b.map(t=>({t:"td",c:t.render?t.render(e[t.key],e):String(e[t.key]||"")}))}))}]}},R.makeTableFromArray=function(e){const{data:t=[],headerRow:r=!0,columns:o,...n}=e;if(!Array.isArray(t)||0===t.length)return R.makeTable({data:[],columns:o||[],...n});let i,a;if(r&&t.length>0)i=t[0].map(function(e){return String(e)}),a=t.slice(1);else{const e=t[0].length;i=[];for(let t=0;t<e;t++)i.push("col"+t);a=t}const s=a.map(function(e){const t={};return i.forEach(function(r,o){t[r]=void 0!==e[o]?e[o]:""}),t}),l=o||i.map(function(e){return{key:e,label:e}});return R.makeTable({data:s,columns:l,...n})},R.makeBarChart=function(e){const{data:t=[],labelKey:r="label",valueKey:o="value",title:n,color:i="#006666",height:a="200px",formatValue:s,showValues:l=!0,showLabels:c=!0,className:d=""}=e;if(!Array.isArray(t)||0===t.length)return{t:"div",a:{class:("bw_bar_chart_container "+d).trim()},c:""};const b=t.map(function(e){return Number(e[o])||0}),_=Math.max.apply(null,b),p=t.map(function(e,t){const o=b[t],n=_>0?o/_*100:0,a=s?s(o):String(o),d=[];return l&&d.push({t:"div",a:{class:"bw_bar_value"},c:a}),d.push({t:"div",a:{class:"bw_bar",style:"height:"+n+"%;background:"+i+";"}}),c&&d.push({t:"div",a:{class:"bw_bar_label"},c:String(e[r]||"")}),{t:"div",a:{class:"bw_bar_group"},c:d}}),m=[];return n&&m.push({t:"h3",a:{class:"bw_bar_chart_title"},c:n}),m.push({t:"div",a:{class:"bw_bar_chart",style:"height:"+a+";"},c:p}),{t:"div",a:{class:("bw_bar_chart_container "+d).trim()},c:m}},R.makeDataTable=function(e){const{title:t,data:r,columns:o,className:n="",striped:i=!0,hover:a=!0,responsive:s=!0,...l}=e,c=R.makeTable({data:r,columns:o,className:n,striped:i,hover:a,...l}),d=[];return t&&d.push({t:"h5",a:{class:"mb-3"},c:t}),s?d.push({t:"div",a:{class:"table-responsive"},c:c}):d.push(c),{t:"div",a:{class:"table-container"},c:d}},R._componentRegistry=new Map,R.render=function(e,t,r){const o="string"==typeof e?document.querySelector(e):e;if(!o)return{object_type:"error",component_id:null,object_handle_in_dom:null,status_code:"error=target_element_not_found"};const n=r.o?.id||R.uuid();let i;try{i=R.createDOM(r)}catch(e){return{object_type:"error",component_id:n,object_handle_in_dom:null,status_code:`error=render_failed:${e.message}`}}i.setAttribute("data-bw_id",n);try{switch(t){case"replace":o.parentNode.replaceChild(i,o);break;case"prepend":o.insertBefore(i,o.firstChild);break;case"append":o.appendChild(i);break;case"before":o.parentNode.insertBefore(i,o);break;case"after":o.parentNode.insertBefore(i,o.nextSibling);break;default:throw new Error(`Invalid position: ${t}`)}}catch(e){return{object_type:"error",component_id:n,object_handle_in_dom:null,status_code:`error=insertion_failed:${e.message}`}}const a={object_type:r.t||"element",component_id:n,object_handle_in_dom:i,status_code:"success",_taco:{...r},_state:{...r.o?.state||{}},_mounted:!0,get element(){return this.object_handle_in_dom},getState(){return{...this._state}},setState(e){return this._state={...this._state,...e},this._taco.o?.onStateChange&&this._taco.o.onStateChange(this._state,e),this},update(){if(!this._mounted||!this.element)return this;const e=this.element.parentNode;this._taco.o&&(this._taco.o.state=this._state);const t=R.createDOM(this._taco);return t.setAttribute("data-bw_id",n),e.replaceChild(t,this.element),this.object_handle_in_dom=t,this._taco.o?.onUpdate&&this._taco.o.onUpdate(t,this._state),this},getProp(e){return this._taco.a?.[e]},setProp(e,t){return this._taco.a||(this._taco.a={}),this._taco.a[e]=t,this.element&&(null==t?this.element.removeAttribute(e):!0===t?this.element.setAttribute(e,""):this.element.setAttribute(e,String(t))),this},getContent(){return this._taco.c},setContent(e){return this._taco.c=e,this.element&&("string"==typeof e?this.element.textContent=e:this.update()),this},addClass(e){return this.element&&this.element.classList.add(e),this},removeClass(e){return this.element&&this.element.classList.remove(e),this},toggleClass(e){return this.element&&this.element.classList.toggle(e),this},hasClass(e){return!!this.element&&this.element.classList.contains(e)},show(){return this.element&&(this.element.style.display=""),this},hide(){return this.element&&(this.element.style.display="none"),this},on(e,t){return this.element&&this.element.addEventListener(e,t),this},off(e,t){return this.element&&this.element.removeEventListener(e,t),this},destroy(){return this._mounted?(this._taco.o?.unmount&&this._taco.o.unmount(this.element),this.element&&this.element.parentNode&&this.element.parentNode.removeChild(this.element),R._componentRegistry.delete(n),this._mounted=!1,this.object_handle_in_dom=null,this.status_code="destroyed",this):this}};return R._componentRegistry.set(n,a),r.o?.mounted&&r.o.mounted(i,a),a},R.getComponent=function(e){return R._componentRegistry.get(e)||null},R.getAllComponents=function(){return new Map(R._componentRegistry)},Object.entries(F).forEach(([e,t])=>{e.startsWith("make")&&(R[e]=t)}),R.make=B,R.BCCL=P,R.variantClass=D,Object.entries(F).forEach(([e,t])=>{if(e.startsWith("make")){const r="create"+e.substring(4);R[r]=function(e){const r=t(e);return R.renderComponent(r)}}}),R._isBrowser&&"undefined"!=typeof window&&(window.bw=R),R});

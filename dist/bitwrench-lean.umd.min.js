...
/**
   ...
   */function t(e,t,r){return Math.max(t,Math.min(r,e))}function r(e,t){void 0===t&&(t=255);var r=[0,0,0,t,"rgb"];if(Array.isArray(e)){for(var n=[0,0,0,255,"rgb"],a=0;a<e.length&&a<n.length;a++)n[a]=e[a];return n}if("#"===(e=String(e).replace(/\s/g,""))[0]){var i=e.slice(1);if(3===i.length||4===i.length)for(var s=0;s<i.length;s++)r[s]=parseInt(i[s]+i[s],16);else if(6===i.length||8===i.length)for(var l=0;l<i.length;l+=2)r[l/2]=parseInt(i.substring(l,l+2),16)}else{var c=e.match(/^(rgb|hsl)a?\(([^)]+)\)$/i);if(c){var d=c[1].toLowerCase(),b=c[2].split(",").map(function(e){return parseFloat(e)});if("rgb"===d)r[0]=b[0]||0,r[1]=b[1]||0,r[2]=b[2]||0,r[3]=void 0!==b[3]?255*b[3]:t,r[4]="rgb";else if("hsl"===d){return o(b[0]||0,b[1]||0,b[2]||0,void 0!==b[3]?255*b[3]:t)}}}return r}function o(e,t,r,o,n){void 0===o&&(o=255),void 0===n&&(n=!0),Array.isArray(e)&&(t=e[1],r=e[2],o=void 0!==e[3]?e[3]:255,e=e[0]);var a,i,s,l=e/360,c=t/100,d=r/100;if(0===c)a=i=s=255*d;else{var b=function(e,t,r){return r<0&&(r+=1),r>1&&(r-=1),r<1/6?e+6*(t-e)*r:r<.5?t:r<2/3?e+(t-e)*(2/3-r)*6:e},m=d<.5?d*(1+c):d+c-d*c,p=2*d-m;a=255*b(p,m,l+1/3),i=255*b(p,m,l),s=255*b(p,m,l-1/3)}return n&&(a=Math.round(a),i=Math.round(i),s=Math.round(s),o=Math.round(o)),[a,i,s,o,"rgb"]}function n(e){var t=r(e),o=function(e,t,r,o){void 0===o&&(o=255),Array.isArray(e)&&(t=e[1],r=e[2],o=void 0!==e[3]?e[3]:255,e=e[0]),e/=255,t/=255,r/=255;var n,a,i=Math.max(e,t,r),s=Math.min(e,t,r),l=(i+s)/2;if(i===s)n=a=0;else{var c=i-s;switch(a=l>.5?c/(2-i-s):c/(i+s),i){case e:n=((t-r)/c+(t<r?6:0))/6;break;case t:n=((r-e)/c+2)/6;break;case r:n=((e-t)/c+4)/6}}return[n*=360,a*=100,l*=100,o,"hsl"]}(t[0],t[1],t[2],255);return[o[0],o[1],o[2]]}function a(e){var t=o(e[0],e[1],e[2],255,!0);return"#"+("0"+t[0].toString(16)).slice(-2)+("0"+t[1].toString(16)).slice(-2)+("0"+t[2].toString(16)).slice(-2)}function i(e,r){var o=n(e);return o[2]=t(o[2]+r,0,100),a(o)}function s(e,t,o){var n=r(e),a=r(t),i=Math.round(n[0]+(a[0]-n[0])*o),s=Math.round(n[1]+(a[1]-n[1])*o),l=Math.round(n[2]+(a[2]-n[2])*o);return"#"+("0"+i.toString(16)).slice(-2)+("0"+s.toString(16)).slice(-2)+("0"+l.toString(16)).slice(-2)}function l(e){var t=r(e),o=[t[0]/255,t[1]/255,t[2]/255].map(function(e){return e<=.03928?e/12.92:Math.pow((e+.055)/1.055,2.4)});return.2126*o[0]+.7152*o[1]+.0722*o[2]}function c(e){return l(e)>.179?"#000":"#fff"}function d(e,t,r){if(void 0===r&&(r=.2),0===r)return e;var o=n(e),i=n(t)[0]-o[0];return i>180&&(i-=360),i<-180&&(i+=360),a([(o[0]+i*r+360)%360,o[1],o[2]])}function b(e){var t=r(e);return{base:e,hover:i(e,-10),active:i(e,-15),light:s(e,"#ffffff",.85),darkText:i(e,-40),border:s(e,"#ffffff",.6),focus:"rgba("+t[0]+","+t[1]+","+t[2]+",0.25)",textOn:c(e)}}function m(e){var r,o,i=n(e),s=i[0],l=i[1],c=i[2];return c>50?(r=t(100-c-10,8,40),o=t(.85*l,0,100)):(r=t(100-c+10,60,92),o=t(1.1*l,0,100)),a([s,o,r])}function p(e){var t=l(e.primary);return e.secondary&&(t=(t+l(e.secondary))/2),e.tertiary&&(t=(2*t+l(e.tertiary))/3),t>.179}function u(e){var t={};t.primary=m(e.primary),t.secondary=m(e.secondary),t.tertiary=e.tertiary?m(e.tertiary):t.primary;var r=n(e.primary),o=r[0];p(e)?(t.light=a([o,Math.min(r[1],15),15]),t.dark=a([o,5,88])):(t.light=a([o,Math.min(r[1],10),96]),t.dark=a([o,10,18]));for(var i=void 0!==e.harmonize?e.harmonize:.2,s={success:"#198754",danger:"#dc3545",warning:"#f0ad4e",info:"#17a2b8"},l=["success","danger","warning","info"],c=0;c<l.length;c++){var b=l[c],u=d(e[b]||s[b],e.primary,i);t[b]=m(u)}return t.harmonize=0,t}function f(e){var t=void 0!==e.harmonize?e.harmonize:.2,r=e.primary,o=n(r)[0],i=d(e.success||"#198754",r,t),s=d(e.danger||"#dc3545",r,t),l=d(e.warning||"#f0ad4e",r,t),c=d(e.info||"#17a2b8",r,t),m=e.light||a([o,8,97]),p=e.dark||a([o,10,13]);return{primary:b(e.primary),secondary:b(e.secondary),tertiary:b(e.tertiary),success:b(i),danger:b(s),warning:b(l),info:b(c),light:b(m),dark:b(p)}}
/**

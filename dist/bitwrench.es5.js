...
(function (global, factory) {
      ...
      c: {
        ...
        c: items.map(function (item, index) {
          return {
            t: 'li',
            a: {
              "class": "bw_breadcrumb_item ".concat(item.active ? 'active' : ''),
  ...
  function makeSpinner() {
    ...
    return {
      t: 'div',
      a: {
        "class": "bw_bccl_spinner bw_spinner_".concat(type, " bw_spinner_").concat(type, "-").concat(size, " ").concat(variantClass(variant)),
        role: 'status'
      },
      c: {
        t: 'span',
  ...
  bw.renderComponent = function () {
    throw new Error('bw.renderComponent has been removed in v2.1. Use bw.create() + bw.mountTree() instead.');
  };
  bw.compileProps = function () {
    throw new Error('bw.compileProps has been removed in v2.1.');
  };

 ...
 */function t(e,t){void 0===t&&(t=255);var o=[0,0,0,t,"rgb"];if(Array.isArray(e)){for(var a=[0,0,0,255,"rgb"],n=0;n<e.length&&n<a.length;n++)a[n]=e[n];return a}if("#"===(e=String(e).replace(/\s/g,""))[0]){var i=e.slice(1);if(3===i.length||4===i.length)for(var s=0;s<i.length;s++)o[s]=parseInt(i[s]+i[s],16);else if(6===i.length||8===i.length)for(var l=0;l<i.length;l+=2)o[l/2]=parseInt(i.substring(l,l+2),16)}else{var c=e.match(/^(rgb|hsl)a?\(([^)]+)\)$/i);if(c){var d=c[1].toLowerCase(),b=c[2].split(",").map(function(e){return parseFloat(e)});if("rgb"===d)o[0]=b[0]||0,o[1]=b[1]||0,o[2]=b[2]||0,o[3]=void 0!==b[3]?255*b[3]:t,o[4]="rgb";else if("hsl"===d){return r(b[0]||0,b[1]||0,b[2]||0,void 0!==b[3]?255*b[3]:t)}}}return o}function r(e,t,r,o,a){void 0===o&&(o=255),void 0===a&&(a=!0),Array.isArray(e)&&(t=e[1],r=e[2],o=void 0!==e[3]?e[3]:255,e=e[0]);var n,i,s,l=e/360,c=t/100,d=r/100;if(0===c)n=i=s=255*d;else{var b=function(e,t,r){return r<0&&(r+=1),r>1&&(r-=1),r<1/6?e+6*(t-e)*r:r<.5?t:r<2/3?e+(t-e)*(2/3-r)*6:e},m=d<.5?d*(1+c):d+c-d*c,u=2*d-m;n=255*b(u,m,l+1/3),i=255*b(u,m,l),s=255*b(u,m,l-1/3)}return a&&(n=Math.round(n),i=Math.round(i),s=Math.round(s),o=Math.round(o)),[n,i,s,o,"rgb"]}function o(e){var r=t(e),o=function(e,t,r,o){void 0===o&&(o=255),Array.isArray(e)&&(t=e[1],r=e[2],o=void 0!==e[3]?e[3]:255,e=e[0]),e/=255,t/=255,r/=255;var a,n,i=Math.max(e,t,r),s=Math.min(e,t,r),l=(i+s)/2;if(i===s)a=n=0;else{var c=i-s;switch(n=l>.5?c/(2-i-s):c/(i+s),i){case e:a=((t-r)/c+(t<r?6:0))/6;break;case t:a=((r-e)/c+2)/6;break;case r:a=((e-t)/c+4)/6}}return[a*=360,n*=100,l*=100,o,"hsl"]}(r[0],r[1],r[2],255);return[o[0],o[1],o[2]]}function a(e){var t=r(e[0],e[1],e[2],255,!0);return"#"+("0"+t[0].toString(16)).slice(-2)+("0"+t[1].toString(16)).slice(-2)+("0"+t[2].toString(16)).slice(-2)}function n(e,t){var r,n,i,s=o(e);return s[2]=(r=s[2]+t,n=0,i=100,Math.max(n,Math.min(i,r))),a(s)}function i(e,r,o){var a=t(e),n=t(r),i=Math.round(a[0]+(n[0]-a[0])*o),s=Math.round(a[1]+(n[1]-a[1])*o),l=Math.round(a[2]+(n[2]-a[2])*o);return"#"+("0"+i.toString(16)).slice(-2)+("0"+s.toString(16)).slice(-2)+("0"+l.toString(16)).slice(-2)}function s(e){var r=t(e),o=[r[0]/255,r[1]/255,r[2]/255].map(function(e){return e<=.03928?e/12.92:Math.pow((e+.055)/1.055,2.4)});return.2126*o[0]+.7152*o[1]+.0722*o[2]}function l(e){return s(e)>.179?"#000":"#fff"}function c(e){var r=t(e);return{base:e,hover:n(e,-10),active:n(e,-15),light:i(e,"#ffffff",.85),darkText:n(e,-40),border:i(e,"#ffffff",.6),focus:"rgba("+r[0]+","+r[1]+","+r[2]+",0.25)",textOn:l(e)}}function d(e){var t="#198754",r="#dc3545",o="#ffc107",a="#0dcaf0",n="#f8f9fa",i="#212529";return{primary:c(e.primary),secondary:c(e.secondary),tertiary:c(e.tertiary),success:c(e.success||t),danger:c(e.danger||r),warning:c(e.warning||o),info:c(e.info||a),light:c(e.light||n),dark:c(e.dark||i)}}
/**

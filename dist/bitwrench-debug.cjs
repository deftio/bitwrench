/*! bitwrench-debug v2.1.10 | BSD-2-Clause | https://deftio.github.io/bitwrench/pages */
'use strict';
...
var hasRequiredBitwrenchDebug;

function requireBitwrenchDebug () {
	if (hasRequiredBitwrenchDebug) return bitwrenchDebug$1.exports;
	hasRequiredBitwrenchDebug = 1;
	(function (module) {
		(function() {
	...
	return bitwrenchDebug$1.exports;
}

var bitwrenchDebugExports = requireBitwrenchDebug();
var bitwrenchDebug = /*@__PURE__*/getDefaultExportFromCjs(bitwrenchDebugExports);

module.exports = bitwrenchDebug;
//# sourceMappingURL=bitwrench-debug.cjs.map

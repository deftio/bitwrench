...
var BWCLIENT_SOURCE = '(function(bw) {\n'
  ...
  + '  };\n'
  + '\n'
  + '  // ── Wire up action click delegation ──\n'
  + '  // Supports both bw_act_* CSS classes and data-bw-action attributes.\n'
  + '  // bw_act_* takes priority when both are present.\n'
  + '  _client._wireActions = function() {\n'
  + '    document.addEventListener("click", function(e) {\n'
  + '      var el = e.target;\n'
  + '      var action = null;\n'
  + '      // Walk up looking for bw_act_* class or data-bw-action attribute\n'
  ...
  + '          }\n'
  + '        }\n'
  + '        if (!action && el.getAttribute && el.getAttribute("data-bw-action")) {\n'
  ...
  + '      e.preventDefault();\n'
  + '      var actionData = {};\n'
  + '      if (el.getAttribute && el.getAttribute("data-bw-id")) actionData.bwId = el.getAttribute("data-bw-id");\n'
  ...
  + '        var btn = form.querySelector("[data-bw-action],.bw_act_");\n'
  + '        var action = null;\n'
  + '        if (btn) {\n'
  + '          if (btn.classList) {\n'
  ...
  + '            }\n'
  + '          }\n'
  + '          if (!action) action = btn.getAttribute("data-bw-action");\n'
  + '          if (action) {\n'

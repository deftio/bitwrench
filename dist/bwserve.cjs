/*! bwserve v2.1.10 | BSD-2-Clause | https://deftio.github.io/bitwrench/pages */
'use strict';
...
var __dirname$1 = path.dirname(url.fileURLToPath((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('bwserve.cjs', document.baseURI).href))));
...
class BwServeApp {
  ...
  _handleRequest(req, res) {
    ...
    var pagePath = (path$1.length > 1 && path$1.endsWith('/')) ? path$1.slice(0, -1) : path$1;
...
//# sourceMappingURL=bwserve.cjs.map

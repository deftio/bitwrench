 ...
 * @license BSD-2-Clause
 * @author M A Chatterjee <deftio [at] deftio [dot] com>
 */const B={version:e.version,versionInfo:e,getVersion:function(){return{...e}},_idCounter:0,_unmountCallbacks:new Map,_topics:{},_subIdCounter:0,_nodeMap:{},__monkey_patch_is_nodejs__:{_value:"ignore",set:function(e){this._value=Y(e,"boolean")?e:"ignore"},get:function(){return this._value}},isNodeJS:function(){return"ignore"!==B.__monkey_patch_is_nodejs__.get()?B.__monkey_patch_is_nodejs__.get():"undefined"!=typeof process&&null!=process.versions&&null!=process.versions.node}};B._isNode=B.isNodeJS(),Object.defineProperty(B,"_isBrowser",{get:function(){return"undefined"!=typeof document&&"undefined"!=typeof window},configurable:!0});var P=Object.prototype.hasOwnProperty,U=Array.isArray,H=Object.keys,q=E,Y=function(e,t){var r=q(e);return r===t||r.toLowerCase()===t},W=function(){console.warn.apply(console,arguments)},X=function(){console.log.apply(console,arguments)},J=function(){console.error.apply(console,arguments)};B.debug=!1,B._fsCache=void 0,B._getFs=function(){if(void 0!==B._fsCache)return Promise.resolve(B._fsCache);if(!B.isNodeJS())return B._fsCache=null,Promise.resolve(null);if("function"==typeof require)try{return B._fsCache=require("fs"),Promise.resolve(B._fsCache)}catch(e){}try{return new Function("m","return import(m)")("fs").then(function(e){return B._fsCache=e.default||e,B._fsCache}).catch(function(){return B._fsCache=null,null})}catch(e){return B._fsCache=null,Promise.resolve(null)}},B.typeOf=E,B.to=B.typeOf,B.uuid=function(e){var t=e?"bw_"+e+"_":"bw_";if(B._isBrowser&&crypto&&crypto.randomUUID)return t+crypto.randomUUID().replace(/-/g,"");return`${t}${Date.now().toString(36)}_${(++B._idCounter).toString(36)}_${Math.random().toString(36).substring(2,11)}`},B._el=function(e){if(!Y(e,"string"))return e||null;if(!e)return null;if(!B._isBrowser)return null;var t=B._nodeMap[e];if(t){if(null!==t.parentNode)return t;delete B._nodeMap[e]}var r=document.getElementById(e);return r||"#"!==e.charAt(0)&&"."!==e.charAt(0)||(r=document.querySelector(e)),r||(r=document.querySelector('[data-bw_id="'+e+'"]')),r||0!==e.indexOf("bw_uuid_")||(r=document.querySelector("."+e)),r&&(B._nodeMap[e]=r),r},B._registerNode=function(e,t){if(e){t&&(B._nodeMap[t]=e);var r=e.getAttribute?e.getAttribute("id"):null;r&&(B._nodeMap[r]=e)}},B._deregisterNode=function(e,t){t&&delete B._nodeMap[t];var r=e&&e.getAttribute?e.getAttribute("id"):null;r&&delete B._nodeMap[r]};var G=/\bbw_uuid_[a-z0-9_]+\b/;function V(e){this._bwComponent=!0,this._bwId=B.uuid("comp"),this.taco=e,this.element=null,this.mounted=!1;var t=e.o||{};if(this._state={},t.state)for(var r in t.state)P.call(t.state,r)&&(this._state[r]=t.state[r]);if(this._actions={},t.actions)for(var o in t.actions)P.call(t.actions,o)&&(this._actions[o]=t.actions[o]);if(this._methods={},t.methods){var n=this;for(var i in t.methods)P.call(t.methods,i)&&(this._methods[i]=t.methods[i],function(e,t){n[e]=function(){var e=[n].concat(Array.prototype.slice.call(arguments));return t.apply(null,e)}}(i,t.methods[i]))}this._userTag=null,this._hooks={willMount:t.willMount||null,mounted:t.mounted||null,willUpdate:t.willUpdate||null,onUpdate:t.onUpdate||t.updated||null,unmount:t.unmount||null,willDestroy:t.willDestroy||null},this._bindings=[],this._dirtyKeys={},this._scheduled=!1,this._subs=[],this._eventListeners=[],this._registeredActions=[],this._prevValues={},this._compile=!!t.compile,this._bw_refs={},this._refCounter=0,this._children=[],this._parent=null,this._factory=e._bwFactory||null}B.assignUUID=function(e,t){if(!e||!Y(e,"object"))return null;e.a||(e.a={}),Y(e.a.class,"string")||(e.a.class=e.a.class?String(e.a.class):"");var r=e.a.class.match(G);if(r&&!t)return r[0];r&&(e.a.class=e.a.class.replace(G,"").replace(/\s+/g," ").trim());var o=B.uuid("uuid");return e.a.class=(e.a.class?e.a.class+" ":"")+o,o},B.getUUID=function(e){if(!e)return null;var t;if(void 0!==e.className&&e.tagName?t=e.className:e.a&&Y(e.a.class,"string")&&(t=e.a.class),!t)return null;var r=t.match(G);return r?r[0]:null},B.escapeHTML=function(e){if(!Y(e,"string"))return"";const t={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;","/":"&#x2F;"};return e.replace(/[&<>"'/]/g,e=>t[e])},B.raw=function(e){return{__bw_raw:!0,v:String(e)}},B.h=function(e,t,r,o){var n={t:String(e)};return null!=t&&(n.a=t),void 0!==r&&(n.c=r),void 0!==o&&(n.o=o),n},B.html=function(e,t={}){if(null==e)return"";if(e&&!0===e._bwComponent){var r=Object.assign({},t);return!r.state&&e._state&&(r.state=e._state),B.html(e.taco,r)}if(U(e))return e.map(e=>B.html(e,t)).join("");if(e&&e.__bw_raw)return e.v;if(e&&e._bwWhen&&t.state){var o=e.expr.replace(/^\$\{|\}$/g,""),n=(t.compile?B._resolveTemplate("${"+o+"}",t.state,!0):B._evaluatePath(t.state,o))?e.branches[0]:e.branches[1]||null;return n?B.html(n,t):""}if(e&&e._bwEach&&t.state){var i=e.expr.replace(/^\$\{|\}$/g,""),a=B._evaluatePath(t.state,i);return U(a)?a.map(function(r,o){return B.html(e.factory(r,o),t)}).join(""):""}if(!Y(e,"object")||!e.t){var s=t.raw?String(e):B.escapeHTML(String(e));return t.state&&Y(s,"string")&&s.indexOf("${")>=0&&(s=B._resolveTemplate(s,t.state,!!t.compile)),s}const{t:l,a:c={},c:d,o:b={}}=e,_=["area","base","br","col","embed","hr","img","input","link","meta","param","source","track","wbr"].includes(l.toLowerCase());let p="";for(const[e,r]of Object.entries(c))if(null!=r&&!1!==r)if(e.startsWith("on"))if(Y(r,"function")){var m=B.funcRegister(r);p+=" "+e+'="'+B.funcGetDispatchStr(m,"event")+'"'}else Y(r,"string")&&(p+=" "+e+'="'+B.escapeHTML(r)+'"');else if("style"===e&&Y(r,"object")){const e=Object.entries(r).filter(([,e])=>null!=e).map(([e,t])=>`${e}:${t}`).join(";");e&&(p+=` style="${B.escapeHTML(e)}"`)}else if("class"===e){const e=U(r)?r.filter(Boolean).join(" "):String(r);e&&(p+=` class="${B.escapeHTML(e)}"`)}else if(!0===r)p+=` ${e}`;else{let o=String(r);t.state&&o.indexOf("${")>=0&&(o=B._resolveTemplate(o,t.state,!!t.compile)),p+=` ${e}="${B.escapeHTML(o)}"`}if((b.mounted||b.unmount)&&!c.class?.includes("bw_id_")){const e=b.bw_id||B.uuid();p=p.replace(/class="([^"]*)"/,(t,r)=>`class="${r} bw_id_${e}"`.trim()),p.includes("class=")||(p+=` class="bw_id_${e}"`)}if(_)return`<${l}${p} />`;let u=null!=d?B.html(d,t):"";return t.state&&Y(u,"string")&&u.indexOf("${")>=0&&(u=B._resolveTemplate(u,t.state,!!t.compile)),`<${l}${p}>${u}</${l}>`},B.htmlPage=function(e){var t=(e=e||{}).title||"bitwrench",r=e.body||"",o=e.state||void 0,n=e.runtime||"shim",i=e.css||"",a=e.theme||null,s=e.head||[],l=e.favicon||"",c=e.lang||"en",d=B._fnIDCounter,b="";if(Y(r,"string"))b=r;else{var _={};o&&(_.state=o),b=B.html(r,_)}for(var p=B._fnIDCounter,m="",u=d;u<p;u++){var f="bw_fn_"+u;B._fnRegistry[f]&&(m+="bw._fnRegistry['"+f+"']="+B._fnRegistry[f].toString()+";\n")}var h="";if("inline"===n){var w=null;if(B._isNode)try{var g="function"==typeof require?require("fs"):null,v="function"==typeof require?require("path"):null;if(g&&v){var y="";try{y=v.dirname("undefined"!=typeof __filename?__filename:"")}catch(e){}if(!y&&void 0!==import.meta&&import.meta.url){var x="function"==typeof require?require("url"):null;x&&x.fileURLToPath&&(y=v.dirname(x.fileURLToPath(import.meta.url)))}if(y){var k=v.resolve(y,"../dist/bitwrench.umd.min.js");w=g.readFileSync(k,"utf8")}}}catch(e){}h=w?"<script>"+w+"<\/script>":"<script>"+B._FUNC_REGISTRY_SHIM+"<\/script>"}else"cdn"===n?h='<script src="https://cdn.jsdelivr.net/npm/bitwrench@2/dist/bitwrench.umd.min.js"><\/script>':"shim"===n&&(h="<script>"+B._FUNC_REGISTRY_SHIM+"<\/script>");var C="";if(a){var j=Y(a,"string")?S[a.toLowerCase()]||null:a;if(j)C=B.generateTheme("",Object.assign({},j,{inject:!1})).css}var T="";U(s)&&s.length>0&&(T=s.map(function(e){return B.html(e)}).join("\n"));var M="";l&&(M='<link rel="icon" href="'+l.replace(/[&<>"']/g,function(e){return{"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"}[e]})+'">');var z=B.escapeHTML(t),O=(C?C+"\n":"")+i,A="",E=[];m&&E.push(m),"inline"!==n&&"cdn"!==n||E.push('if(typeof bw!=="undefined"){bw.loadDefaultStyles();}'),E.length>0&&(A="<script>\n"+E.join("\n")+"\n<\/script>");var I=["<!DOCTYPE html>",'<html lang="'+c+'">',"<head>",'<meta charset="UTF-8">','<meta name="viewport" content="width=device-width, initial-scale=1">'];return I.push("<title>"+z+"</title>"),M&&I.push(M),h&&I.push(h),T&&I.push(T),O&&I.push("<style>"+O+"</style>"),I.push("</head>"),I.push("<body>"),I.push(b),A&&I.push(A),I.push("</body>"),I.push("</html>"),I.join("\n")},B.createDOM=function(e,t={}){if(!B._isBrowser)throw new Error("bw.createDOM requires a DOM environment (document/window). Use bw.html() instead.");if(null==e)return document.createTextNode("");if(e&&e.__bw_raw){var r=document.createDocumentFragment(),o=document.createElement("span");for(o.innerHTML=e.v;o.firstChild;)r.appendChild(o.firstChild);return r}if(e&&!0===e._bwComponent)return B.createDOM(e.taco,t);if(!Y(e,"object")||!e.t)return document.createTextNode(String(e));const{t:n,a:i={},c:a,o:s={}}=e,l=document.createElement(n);for(const[e,t]of Object.entries(i))if(null!=t&&!1!==t)if("style"===e&&Y(t,"object"))Object.assign(l.style,t);else if("class"===e){const e=U(t)?t.filter(Boolean).join(" "):String(t);e&&(l.className=e)}else if(e.startsWith("on")&&Y(t,"function")){const r=e.slice(2).toLowerCase();l.addEventListener(r,t)}else"value"===e&&"input"===n?l.value=t:!0===t?l.setAttribute(e,""):l.setAttribute(e,String(t));if(null!=a)if(U(a))a.forEach(e=>{if(null!=e){if(!0===e._bwComponent)return void e.mount(l);var r=B.createDOM(e,t);l.appendChild(r);var o=e&&e.a?e.a["data-bw_id"]||e.a.id:null;if(o&&(l._bw_refs||(l._bw_refs={}),l._bw_refs[o]=r),r._bw_refs)for(var n in l._bw_refs||(l._bw_refs={}),r._bw_refs)P.call(r._bw_refs,n)&&(l._bw_refs[n]=r._bw_refs[n])}});else if(Y(a,"object")&&a.__bw_raw)l.innerHTML=a.v;else if(!0===a._bwComponent)a.mount(l);else if(Y(a,"object")&&a.t){var c=B.createDOM(a,t);l.appendChild(c);var d=a.a?a.a["data-bw_id"]||a.a.id:null;if(d&&(l._bw_refs||(l._bw_refs={}),l._bw_refs[d]=c),c._bw_refs)for(var b in l._bw_refs||(l._bw_refs={}),c._bw_refs)P.call(c._bw_refs,b)&&(l._bw_refs[b]=c._bw_refs[b])}else l.textContent=String(a);if(i.id&&B._registerNode(l,null),l.className){var _=l.className.match(G);_&&(B._nodeMap[_[0]]=l)}if(s.mounted||s.unmount||s.render||s.state){const e=i["data-bw_id"]||B.uuid();l.setAttribute("data-bw_id",e),B._registerNode(l,e),s.state&&(l._bw_state=s.state),s.render?(l._bw_render=s.render,s.mounted&&W("bw.createDOM: o.render and o.mounted are mutually exclusive. o.render wins."),document.body.contains(l)?s.render(l,l._bw_state||{}):requestAnimationFrame(()=>{document.body.contains(l)&&s.render(l,l._bw_state||{})})):s.mounted&&(document.body.contains(l)?s.mounted(l,l._bw_state||{}):requestAnimationFrame(()=>{document.body.contains(l)&&s.mounted(l,l._bw_state||{})})),s.unmount&&B._unmountCallbacks.set(e,()=>{s.unmount(l,l._bw_state||{})})}else i["data-bw_id"]&&B._registerNode(l,i["data-bw_id"]);return l},B.DOM=function(e,t,r={}){if(!B._isBrowser)throw new Error("bw.DOM requires a DOM environment (document/window). Use bw.html() instead.");const o=B._el(e);if(!o)return J("bw.DOM: Target element not found:",e),null;const n=o._bw_state,i=o._bw_render,a=o.getAttribute("data-bw_id"),s=o._bw_subs;return delete o._bw_subs,B.cleanup(o),void 0!==n&&(o._bw_state=n),i&&(o._bw_render=i),a&&(o.setAttribute("data-bw_id",a),B._registerNode(o,a)),s&&(o._bw_subs=s),o.innerHTML="",null!=t&&(!0===t._bwComponent?t.mount(o):t.element instanceof Element?o.appendChild(t.element):U(t)?t.forEach(e=>{null!=e&&(!0===e._bwComponent?e.mount(o):e.element instanceof Element?o.appendChild(e.element):o.appendChild(B.createDOM(e,r)))}):o.appendChild(B.createDOM(t,r))),o},B.compileProps=function(e,t={}){const r={};return H(t).forEach(t=>{Object.defineProperty(r,t,{get:()=>e._props[t],set(r){const o=e._props[t];o!==r&&(e._props[t]=r,e.onPropChange&&e.onPropChange(t,r,o))},enumerable:!0,configurable:!0})}),r},B.renderComponent=function(e,t={}){const r=B.createDOM(e,t),o={element:r,taco:e,_props:{...e.a},_state:e.o?.state||{},_children:{},get props(){return this._compiledProps||(this._compiledProps=B.compileProps(this,this._props)),this._compiledProps},$(e){return this.element.querySelectorAll(e)},$first(e){return this.element.querySelector(e)},update(e){Object.assign(this._props,e);const r={...this.taco,a:{...this.taco.a,...e}},o=B.createDOM(r,t);return this.element.replaceWith(o),this.element=o,this.taco=r,this},render(){const e=B.createDOM(this.taco,t);return this.element.replaceWith(e),this.element=e,this},onPropChange(e,t,r){this.render()},get state(){return this._state},set state(e){this._state=e,this.render()},setState(e){return Object.assign(this._state,e),this.render(),this},addChild(e,t){return this._children[e]=t,this},getChild(e){return this._children[e]},destroy(){Object.values(this._children).forEach(e=>{e&&e.destroy&&e.destroy()}),B.cleanup(this.element),this.element.remove(),this._children={},this._props={},this._state={},this._compiledProps=null}};return r._bwHandle=o,o},B.cleanup=function(e){if(!B._isBrowser||!e)return;var t=e.className&&e.className.match(G);t&&delete B._nodeMap[t[0]],e.querySelectorAll('[class*="bw_uuid_"]').forEach(function(e){var t=e.className&&e.className.match(G);t&&delete B._nodeMap[t[0]]});e.querySelectorAll("[data-bw_id]").forEach(e=>{const t=e.getAttribute("data-bw_id"),r=B._unmountCallbacks.get(t);r&&(r(),B._unmountCallbacks.delete(t)),B._deregisterNode(e,t);var o=e.className&&e.className.match(G);o&&delete B._nodeMap[o[0]],e._bw_subs&&(e._bw_subs.forEach(function(e){e()}),delete e._bw_subs),delete e._bw_state,delete e._bw_render,delete e._bw_refs});const r=e.getAttribute("data-bw_id");if(r){const t=B._unmountCallbacks.get(r);t&&(t(),B._unmountCallbacks.delete(r)),B._deregisterNode(e,r);var o=e.className&&e.className.match(G);o&&delete B._nodeMap[o[0]],e._bw_subs&&(e._bw_subs.forEach(function(e){e()}),delete e._bw_subs),delete e._bw_state,delete e._bw_render,delete e._bw_refs,e._bwComponentHandle&&(e._bwComponentHandle.mounted=!1,e._bwComponentHandle.element=null,delete e._bwComponentHandle)}},B.update=function(e){var t=B._el(e);return t&&t._bw_render&&(t._bw_render(t,t._bw_state||{}),B.emit(t,"statechange",t._bw_state)),t||null},B.patch=function(e,t,r){var o=B._el(e);return o?(r?o.setAttribute(r,String(t)):U(t)?(o.innerHTML="",t.forEach(function(e){Y(e,"string")||Y(e,"number")?o.appendChild(document.createTextNode(String(e))):e&&e.t&&o.appendChild(B.createDOM(e))})):Y(t,"object")&&t.t?(o.innerHTML="",o.appendChild(B.createDOM(t))):o.textContent=String(t),o):null},B.patchAll=function(e){var t={};for(var r in e)P.call(e,r)&&(t[r]=B.patch(r,e[r]));return t},B.emit=function(e,t,r){var o=B._el(e);o&&o.dispatchEvent(new CustomEvent("bw:"+t,{bubbles:!0,detail:r||{}}))},B.on=function(e,t,r){var o=B._el(e);return o&&o.addEventListener("bw:"+t,function(e){r(e.detail,e)}),o||null},B.pub=function(e,t){var r=B._topics[e];if(!r||0===r.length)return 0;for(var o=r.slice(),n=0,i=0;i<o.length;i++)try{o[i].handler(t),n++}catch(t){W('bw.pub: subscriber error on topic "'+e+'":',t)}return n},B.sub=function(e,t,r){var o=++B._subIdCounter;B._topics[e]||(B._topics[e]=[]),B._topics[e].push({handler:t,id:o});var n=function(){var t=B._topics[e];t&&(B._topics[e]=t.filter(function(e){return e.id!==o}),0===B._topics[e].length&&delete B._topics[e])};if(r&&(r._bw_subs||(r._bw_subs=[]),r._bw_subs.push(n),!r.getAttribute("data-bw_id"))){var i="bw_sub_"+o;r.setAttribute("data-bw_id",i)}return n},B.unsub=function(e,t){var r=B._topics[e];if(!r)return 0;var o=r.length;B._topics[e]=r.filter(function(e){return e.handler!==t});var n=o-B._topics[e].length;return 0===B._topics[e].length&&delete B._topics[e],n},B._fnRegistry={},B._fnIDCounter=0,B.funcRegister=function(e,t){if(!Y(e,"function"))return"";var r=Y(t,"string")&&t.length>0?t:"bw_fn_"+B._fnIDCounter++;return B._fnRegistry[r]=e,r},B.funcGetById=function(e,t){return(e=String(e))in B._fnRegistry?B._fnRegistry[e]:Y(t,"function")?t:function(){W('bw.funcGetById: unregistered fn "'+e+'"')}},B.funcGetDispatchStr=function(e,t){return"bw.funcGetById('"+e+"')("+(t=null!=t?String(t):"")+")"},B.funcUnregister=function(e){return e in B._fnRegistry&&(delete B._fnRegistry[e],!0)},B.funcGetRegistry=function(){var e={};for(var t in B._fnRegistry)P.call(B._fnRegistry,t)&&(e[t]=B._fnRegistry[t]);return e},B._FUNC_REGISTRY_SHIM='(function(){var bw=window.bw||(window.bw={});if(!bw._fnRegistry)bw._fnRegistry={};bw.funcGetById=function(n){return bw._fnRegistry[n]||function(){console.warn("bw: unregistered fn "+n)};};bw.funcRegister=function(fn,name){var id=name||("bw_fn_"+(bw._fnIDCounter=(bw._fnIDCounter||0)+1));bw._fnRegistry[id]=fn;return id;};window.bw=bw;})();',B._parseBindings=function(e){for(var t,r=[],o=/\$\{([^}]+)\}/g;null!==(t=o.exec(e));)r.push({start:t.index,end:t.index+t[0].length,expr:t[1].trim()});return r},B._evaluatePath=function(e,t){for(var r=t.split("."),o=e,n=0;n<r.length;n++){if(null==o)return B.debug&&W('bw.debug: _evaluatePath — null at key "'+r[n]+'" in path "'+t+'"'),"";o=o[r[n]]}return null==o?"":o},B._compiledExprs={},B._resolveTemplate=function(e,t,r){if(!Y(e,"string")||e.indexOf("${")<0)return e;var o=B._parseBindings(e);if(0===o.length)return e;for(var n="",i=0,a=0;a<o.length;a++){var s,l=o[a];if(n+=e.slice(i,l.start),r){if(!B._compiledExprs[l.expr])try{B._compiledExprs[l.expr]=new Function("state","with(state){return ("+l.expr+");}")}catch(e){B._compiledExprs[l.expr]=function(){return""}}try{s=B._compiledExprs[l.expr](t)}catch(e){B.debug&&W('bw.debug: _resolveTemplate — Tier 2 eval failed for "${'+l.expr+'}":',e.message),s=""}}else s=B._evaluatePath(t,l.expr);n+=null==s?"":String(s),i=l.end}return n+=e.slice(i)},B._extractDeps=function(e,t){for(var r=[],o=0;o<t.length;o++){var n=t[o];(new RegExp("(?:^|[^\\w$.])"+n.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")+"(?:[^\\w$]|$)").test(e)||e===n||0===e.indexOf(n+"."))&&r.push(n)}return r},B._dirtyComponents=[],B._flushScheduled=!1,B._scheduleFlush=function(){B._flushScheduled||(B._flushScheduled=!0,"undefined"!=typeof Promise?Promise.resolve().then(B._doFlush):setTimeout(B._doFlush,0))},B._doFlush=function(){B._flushScheduled=!1;var e=B._dirtyComponents.slice();B._dirtyComponents=[];for(var t={},r=0;r<e.length;r++){var o=e[r];t[o._bwId]||(t[o._bwId]=!0,o._flush())}},B.flush=function(){B._doFlush()};var K=V.prototype;K.get=function(e){return B._evaluatePath(this._state,e)},K.set=function(e,t,r){for(var o=e.split("."),n=this._state,i=0;i<o.length-1;i++)Y(n[o[i]],"object")||(B.debug&&W('bw.debug: set() — auto-creating intermediate "'+o[i]+'" in path "'+e+'"'),n[o[i]]={}),n=n[o[i]];n[o[o.length-1]]=t,this._dirtyKeys[o[0]]=!0,this.mounted&&(r&&r.sync?this._flush():this._scheduleDirty())},K.getState=function(){var e={};for(var t in this._state)P.call(this._state,t)&&(e[t]=this._state[t]);return e},K.setState=function(e,t){for(var r in e)P.call(e,r)&&(this._state[r]=e[r],this._dirtyKeys[r]=!0);this.mounted&&(t&&t.sync?this._flush():this._scheduleDirty())},K.push=function(e,t){var r=this.get(e),o=U(r)?r.slice():[];o.push(t),this.set(e,o)},K.splice=function(e,t,r){var o=this.get(e),n=U(o)?o.slice():[],i=[t,r].concat(Array.prototype.slice.call(arguments,3));Array.prototype.splice.apply(n,i),this.set(e,n)},K._scheduleDirty=function(){this._scheduled||(this._scheduled=!0,B._dirtyComponents.push(this),B._scheduleFlush())},K._compileBindings=function(){this._bindings=[],this._refCounter=0;var e=H(this._state),t=this;!function r(o,n){if(!Y(o,"object")||!o.t)return o;if(Y(o.c,"string")&&o.c.indexOf("${")>=0){for(var i="bw_ref_"+t._refCounter++,a=B._parseBindings(o.c),s=[],l=0;l<a.length;l++)s=s.concat(B._extractDeps(a[l].expr,e));t._bindings.push({expr:o.c,type:"content",refId:i,deps:s,template:o.c}),o.a||(o.a={}),o.a["data-bw_ref"]=i}if(o.a)for(var c in o.a)if(P.call(o.a,c)&&"data-bw_ref"!==c){var d=o.a[c];if(Y(d,"string")&&d.indexOf("${")>=0){for(var b="bw_ref_"+t._refCounter++,_=B._parseBindings(d),p=[],m=0;m<_.length;m++)p=p.concat(B._extractDeps(_[m].expr,e));t._bindings.push({expr:d,type:"attribute",attrName:c,refId:b,deps:p,template:d}),o.a||(o.a={}),o.a["data-bw_ref"]=o.a["data-bw_ref"]||b,o.a["data-bw_ref"]!==b&&(o.a["data-bw_ref_"+c]=b)}}if(U(o.c))for(var u=0;u<o.c.length;u++){if(Y(o.c[u],"string")&&o.c[u].indexOf("${")>=0){for(var f="bw_ref_"+t._refCounter++,h=B._parseBindings(o.c[u]),w=[],g=0;g<h.length;g++)w=w.concat(B._extractDeps(h[g].expr,e));t._bindings.push({expr:o.c[u],type:"content",refId:f,deps:w,template:o.c[u]}),o.c[u]={t:"span",a:{"data-bw_ref":f,style:"display:contents"},c:o.c[u]}}if(Y(o.c[u],"object")&&o.c[u].t&&r(o.c[u],n.concat(u)),o.c[u]&&o.c[u]._bwWhen){var v="bw_ref_"+t._refCounter++,y=B._extractDeps(o.c[u].expr.replace(/^\$\{|\}$/g,""),e);t._bindings.push({expr:o.c[u].expr,type:"structural",subtype:"when",refId:v,deps:y,branches:o.c[u].branches,index:u,parentPath:n}),o.c[u]._refId=v}if(o.c[u]&&o.c[u]._bwEach){var x="bw_ref_"+t._refCounter++,k=B._extractDeps(o.c[u].expr.replace(/^\$\{|\}$/g,""),e);t._bindings.push({expr:o.c[u].expr,type:"structural",subtype:"each",refId:x,deps:k,factory:o.c[u].factory,index:u,parentPath:n}),o.c[u]._refId=x}}else Y(o.c,"object")&&o.c.t&&r(o.c,n.concat(0));return o}(this.taco,[])},K._collectRefs=function(){if(this._bw_refs={},this.element){for(var e=this.element.querySelectorAll("[data-bw_ref]"),t=0;t<e.length;t++)this._bw_refs[e[t].getAttribute("data-bw_ref")]=e[t];var r=this.element.getAttribute&&this.element.getAttribute("data-bw_ref");r&&(this._bw_refs[r]=this.element)}},K.mount=function(e){this._hooks.willMount&&this._hooks.willMount(this),this._originalTaco||(this._originalTaco=this.taco),this.taco=this._deepCloneTaco(this._originalTaco),this._compileBindings(),this._prepareTaco(this.taco);var t=this;for(var r in this._actions)if(P.call(this._actions,r)){var o=this._bwId+"_"+r;(function(e){B.funcRegister(function(r){t._actions[e](t,r)},o)})(r),this._registeredActions.push(o)}this._wireActions(this.taco);var n=this._tacoForDOM(this.taco);this.element=B.createDOM(n),this.element._bwComponentHandle=this,this.element.setAttribute("data-bw_comp_id",this._bwId),this.taco.o&&this.taco.o.render&&(this.element._bw_render=this.taco.o.render),this._userTag&&this.element.classList.add(this._userTag),e.appendChild(this.element),this._collectRefs(),this._resolveAndApplyAll(),this.mounted=!0;for(var i=this.element.querySelectorAll("[data-bw_comp_id]"),a=0;a<i.length;a++){var s=i[a]._bwComponentHandle;s&&s!==this&&!s._parent&&(s._parent=this,this._children.push(s))}this._hooks.mounted&&(2===this._hooks.mounted.length?this._hooks.mounted(this.element,this.getState()):this._hooks.mounted(this)),this.element._bw_render&&this.element._bw_render(this.element,this._state)},K._prepareTaco=function(e){if(Y(e,"object"))if(U(e.c))for(var t=e.c.length-1;t>=0;t--){var r=e.c[t];if(r&&r._bwWhen){var o,n=r.expr.replace(/^\$\{|\}$/g,"");if(this._compile)try{o=new Function("state","with(state){return ("+n+");}")(this._state)}catch(e){o=!1}else o=B._evaluatePath(this._state,n);var i=o?r.branches[0]:r.branches[1]||null;e.c[t]=i?{t:"span",a:{"data-bw_when":r._refId,style:"display:contents"},c:i}:{t:"span",a:{"data-bw_when":r._refId,style:"display:contents"},c:""}}if(r&&r._bwEach){var a=r.expr.replace(/^\$\{|\}$/g,""),s=B._evaluatePath(this._state,a),l=[];if(U(s))for(var c=0;c<s.length;c++)l.push(r.factory(s[c],c));e.c[t]={t:"span",a:{"data-bw_each":r._refId,style:"display:contents"},c:l}}Y(e.c[t],"object")&&e.c[t].t&&this._prepareTaco(e.c[t])}else Y(e.c,"object")&&e.c.t&&this._prepareTaco(e.c)},K._wireActions=function(e){if(Y(e,"object")&&e.t){if(e.a)for(var t in e.a)if(P.call(e.a,t)&&t.startsWith("on")&&Y(e.a[t],"string")){var r=e.a[t];if(r in this._actions)(function(r){e.a[t]=function(e){B.funcGetById(r)(e)}})(this._bwId+"_"+r)}if(U(e.c))for(var o=0;o<e.c.length;o++)this._wireActions(e.c[o]);else Y(e.c,"object")&&e.c.t&&this._wireActions(e.c)}},K._deepCloneTaco=function(e){if(null==e)return e;if(e._bwWhen)return{_bwWhen:!0,expr:e.expr,branches:[this._deepCloneTaco(e.branches[0]),e.branches[1]?this._deepCloneTaco(e.branches[1]):null],_refId:e._refId};if(e._bwEach)return{_bwEach:!0,expr:e.expr,factory:e.factory,_refId:e._refId};if(!Y(e,"object")||!e.t)return e;var t={t:e.t};if(e.a)for(var r in t.a={},e.a)P.call(e.a,r)&&(t.a[r]=e.a[r]);return null!=e.c&&(U(e.c)?t.c=e.c.map(function(e){return this._deepCloneTaco(e)}.bind(this)):Y(e.c,"object")?t.c=this._deepCloneTaco(e.c):t.c=e.c),e.o&&(t.o=e.o),t},K._tacoForDOM=function(e){if(!Y(e,"object")||!e.t)return e;var t={t:e.t};return e.a&&(t.a=e.a),null!=e.c&&(U(e.c)?t.c=e.c.map(function(e){return this._tacoForDOM(e)}.bind(this)):Y(e.c,"object")&&e.c.t?t.c=this._tacoForDOM(e.c):t.c=e.c),e.o&&(e.o.mounted||e.o.render||e.o.unmount)&&W("bw: _tacoForDOM stripped o.mounted/render/unmount from child <"+e.t+">. Use onclick attribute or bw.component() for child interactivity."),t},K.unmount=function(){if(this.mounted){this._hooks.unmount&&this._hooks.unmount(this);for(var e=0;e<this._eventListeners.length;e++){var t=this._eventListeners[e];this.element&&this.element.removeEventListener(t.event,t.handler)}this._eventListeners=[];for(var r=0;r<this._subs.length;r++)this._subs[r]();this._subs=[],this.element&&this.element.parentNode&&this.element.parentNode.removeChild(this.element),this.mounted=!1}},K.destroy=function(){this._hooks.willDestroy&&this._hooks.willDestroy(this);for(var e=this._children.length-1;e>=0;e--)this._children[e].destroy();if(this._children=[],this._parent){var t=this._parent._children.indexOf(this);t>=0&&this._parent._children.splice(t,1),this._parent=null}this.unmount();for(var r=0;r<this._registeredActions.length;r++)B.funcUnregister(this._registeredActions[r]);this._registeredActions=[],this._state={},this._bindings=[],this._bw_refs={},this._prevValues={},this._dirtyKeys={},this.element&&(delete this.element._bwComponentHandle,this.element=null)},K._flush=function(){this._scheduled=!1;var e=H(this._dirtyKeys);if(this._dirtyKeys={},0!==e.length&&this.mounted){if(this._factory){for(var t=!1,r=0;r<e.length;r++)if(P.call(this._factory.props,e[r])){t=!0;break}if(t){var o={};for(var n in this._factory.props)P.call(this._factory.props,n)&&(o[n]=this._factory.props[n]);for(var i in this._state)P.call(this._state,i)&&(o[i]=this._state[i]);this._factory.props=o;var a=B.make(this._factory.type,o);return a._bwFactory=this._factory,this.taco=a,this._originalTaco=this._deepCloneTaco(a),this._render(),void(this._hooks.onUpdate&&this._hooks.onUpdate(this,e))}}this._hooks.willUpdate&&this._hooks.willUpdate(this,e);for(var s=!1,l=0;l<this._bindings.length;l++){var c=this._bindings[l];if("structural"===c.type){for(var d=0;d<c.deps.length;d++)if(e.indexOf(c.deps[d])>=0){s=!0;break}if(s)break}}if(s)this._render();else{var b=this._resolveBindings(e);this._applyPatches(b)}this._hooks.onUpdate&&this._hooks.onUpdate(this,e)}},K._resolveBindings=function(e){for(var t=[],r=0;r<this._bindings.length;r++){var o=this._bindings[r];if("structural"!==o.type){for(var n=!1,i=0;i<o.deps.length;i++)if(e.indexOf(o.deps[i])>=0){n=!0;break}if(n){var a=B._resolveTemplate(o.template,this._state,this._compile),s=o.refId+"_"+(o.attrName||"content");this._prevValues[s]!==a&&(this._prevValues[s]=a,t.push({refId:o.refId,type:o.type,attrName:o.attrName,value:a}))}}}return t},K._applyPatches=function(e){for(var t=0;t<e.length;t++){var r=e[t],o=this._bw_refs[r.refId];o?"content"===r.type?o.textContent=r.value:"attribute"===r.type&&("class"===r.attrName?o.className=r.value:o.setAttribute(r.attrName,r.value)):B.debug&&W('bw.debug: _applyPatches — ref "'+r.refId+'" not found in DOM')}},K._resolveAndApplyAll=function(){for(var e=[],t=0;t<this._bindings.length;t++){var r=this._bindings[t];if("structural"!==r.type){var o=B._resolveTemplate(r.template,this._state,this._compile),n=r.refId+"_"+(r.attrName||"content");this._prevValues[n]=o,e.push({refId:r.refId,type:r.type,attrName:r.attrName,value:o})}}this._applyPatches(e)},K._render=function(){if(this.element&&this.element.parentNode){var e=this.element.parentNode,t=this.element.nextSibling;e.removeChild(this.element),this.taco=this._deepCloneTaco(this._originalTaco||this.taco),this._compileBindings(),this._prepareTaco(this.taco),this._wireActions(this.taco);var r=this._tacoForDOM(this.taco);this.element=B.createDOM(r),this.element._bwComponentHandle=this,this.element.setAttribute("data-bw_comp_id",this._bwId),t?e.insertBefore(this.element,t):e.appendChild(this.element),this._collectRefs(),this._resolveAndApplyAll()}},K.on=function(e,t){this.element&&this.element.addEventListener(e,t),this._eventListeners.push({event:e,handler:t})},K.off=function(e,t){this.element&&this.element.removeEventListener(e,t),this._eventListeners=this._eventListeners.filter(function(r){return!(r.event===e&&r.handler===t)})},K.sub=function(e,t){var r=B.sub(e,t);return this._subs.push(r),r},K.action=function(e){var t=this._actions[e];if(t){var r=[this].concat(Array.prototype.slice.call(arguments,1));return t.apply(null,r)}W('ComponentHandle.action: unknown action "'+e+'"')},K.select=function(e){return this.element?this.element.querySelector(e):null},K.selectAll=function(e){return this.element?Array.prototype.slice.call(this.element.querySelectorAll(e)):[]},K.userTag=function(e){return this._userTag=e,this.element&&this.element.classList.add(e),this},B._ComponentHandle=V,B.when=function(e,t,r){return{_bwWhen:!0,expr:e,branches:[t,r||null]}},B.each=function(e,t){return{_bwEach:!0,expr:e,factory:t}},B.component=function(e){return new V(e)},B.message=function(e,t,r){var o=B._el(e);if(o&&o._bwComponentHandle||(o=B.$('[data-bw_comp_id="'+e+'"]')[0]),o&&o._bwComponentHandle||(o=B.$("."+e)[0]),!o||!o._bwComponentHandle)return!1;var n=o._bwComponentHandle;return Y(n[t],"function")?(n[t](r),!0):(W('bw.message: unknown action "'+t+'" on component '+e),!1)},B._clientFunctions={},B._allowExec=!1,B._builtinClientFunctions={scrollTo:function(e){var t=B._el(e);t&&(t.scrollTop=t.scrollHeight)},focus:function(e){var t=B._el(e);t&&Y(t.focus,"function")&&t.focus()},download:function(e,t,r){if("undefined"!=typeof document){var o=new Blob([t],{type:r||"text/plain"}),n=document.createElement("a");n.href=URL.createObjectURL(o),n.download=e,n.click(),URL.revokeObjectURL(n.href)}},clipboard:function(e){"undefined"!=typeof navigator&&navigator.clipboard&&navigator.clipboard.writeText(e)},redirect:function(e){"undefined"!=typeof window&&(window.location.href=e)},log:function(){console.log.apply(console,arguments)}},B.clientParse=function(e){if("r"!==(e=(e||"").trim()).charAt(0))return JSON.parse(e);for(var t=[],r=0,o=(e=e.slice(1)).length;r<o;){var n=e[r];if("'"===n){for(t.push('"'),r++;r<o;){var i=e[r];if("\\"===i&&r+1<o){var a=e[r+1];"'"===a?t.push("'"):(t.push("\\"),t.push(a)),r+=2}else if('"'===i)t.push('\\"'),r++;else{if("'"===i)break;t.push(i),r++}}t.push('"'),r++}else if('"'===n)for(t.push(n),r++;r<o;){var s=e[r];if("\\"===s&&r+1<o)t.push(s),t.push(e[r+1]),r+=2;else if(t.push(s),r++,'"'===s)break}else if(","===n){for(var l=r+1;l<o&&(" "===e[l]||"\t"===e[l]||"\n"===e[l]||"\r"===e[l]);)l++;l<o&&("}"===e[l]||"]"===e[l])||t.push(n),r++}else t.push(n),r++}return JSON.parse(t.join(""))},B.clientApply=function(e){if(!e||!e.type)return!1;var t=e.type,r=e.target;if("replace"===t){var o=B._el(r);return!!o&&(B.DOM(o,e.node),!0)}if("patch"===t)return null!==B.patch(r,e.content,e.attr);if("append"===t){var n=B._el(r);if(!n)return!1;var i=B.createDOM(e.node);return n.appendChild(i),!0}if("remove"===t){var a=B._el(r);return!!a&&(Y(B.cleanup,"function")&&B.cleanup(a),a.remove(),!0)}if("batch"===t){if(!U(e.ops))return!1;var s=!0;return e.ops.forEach(function(e){B.clientApply(e)||(s=!1)}),s}if("message"===t)return B.message(e.target,e.action,e.data);if("register"===t){if(!e.name||!e.body)return!1;try{return B._clientFunctions[e.name]=new Function("return "+e.body)(),!0}catch(t){return J("[bw] register error:",e.name,t),!1}}else if("call"===t){if(!e.name)return!1;var l=B._clientFunctions[e.name]||B._builtinClientFunctions[e.name];if(!Y(l,"function"))return!1;try{var c=U(e.args)?e.args:[];return l.apply(null,c),!0}catch(t){return J("[bw] call error:",e.name,t),!1}}else if("exec"===t){if(!B._allowExec)return W("[bw] exec rejected: allowExec is not enabled"),!1;if(!e.code)return!1;try{return new Function(e.code)(),!0}catch(e){return J("[bw] exec error:",e),!1}}return!1},B.clientConnect=function(e,t){var r=(t=t||{}).transport||"sse",o=t.actionUrl||e.replace(/\/events\//,"/action/"),n=!1!==t.reconnect,i=t.onStatus||function(){},a=t.onMessage||null,s={};B._allowExec=!!t.allowExec;var l={status:"connecting",_es:null,_pollTimer:null};function c(e){l.status=e,i(e)}function d(e){try{var t=Y(e,"string")?B.clientParse(e):e;a&&a(t),s.message&&s.message(t),B.clientApply(t)}catch(e){s.error&&s.error(e)}}if("sse"===r&&"undefined"!=typeof EventSource){c("connecting");var b=new EventSource(e);l._es=b,b.onopen=function(){c("connected"),s.open&&s.open()},b.onmessage=function(e){d(e.data)},b.onerror=function(){"connected"===l.status&&c("disconnected"),s.error&&s.error(new Error("SSE connection error")),n||b.close()}}else if("poll"===r){var _=t.interval||2e3;c("connected"),l._pollTimer=setInterval(function(){fetch(e).then(function(e){return e.json()}).then(function(e){U(e)?e.forEach(d):e&&e.type&&d(e)}).catch(function(e){s.error&&s.error(e)})},_)}return l.sendAction=function(e,t){var r=JSON.stringify({type:"action",action:e,data:t||{}});fetch(o,{method:"POST",headers:{"Content-Type":"application/json"},body:r}).catch(function(e){s.error&&s.error(e)})},l.on=function(e,t){return s[e]=t,l},l.close=function(){l._es&&(l._es.close(),l._es=null),l._pollTimer&&(clearInterval(l._pollTimer),l._pollTimer=null),c("disconnected"),s.close&&s.close()},l},B.inspect=function(e){var t,r=e;if(e&&!0===e._bwComponent)r=e.element,t=e;else{if(Y(e,"string")&&(r=B.$(e)[0]),!r)return W("bw.inspect: element not found"),null;t=r._bwComponentHandle}if(!t)return X("bw.inspect: no ComponentHandle on this element"),X("  Tag:",r.tagName),X("  Classes:",r.className),X("  _bw_state:",r._bw_state||"(none)"),null;var o=t._bindings.reduce(function(e,t){return e.concat(t.deps||[])},[]).filter(function(e,t,r){return r.indexOf(e)===t});return console.group("Component: "+t._bwId),X("State:",t._state),X("Bindings:",t._bindings.length,"(deps:",o,")"),X("Methods:",H(t._methods)),X("Actions:",H(t._actions)),X("User tag:",t._userTag||"(none)"),X("Mounted:",t.mounted),X("Element:",t.element),console.groupEnd(),t},B.compile=function(e){var t=[];return function e(r){if(Y(r,"object")){if(Y(r.c,"string")&&r.c.indexOf("${")>=0)for(var o=B._parseBindings(r.c),n=0;n<o.length;n++)try{t.push({expr:o[n].expr,fn:new Function("state","with(state){return ("+o[n].expr+");}")})}catch(e){t.push({expr:o[n].expr,fn:function(){return""}})}if(r.a)for(var i in r.a)if(P.call(r.a,i)){var a=r.a[i];if(Y(a,"string")&&a.indexOf("${")>=0)for(var s=B._parseBindings(a),l=0;l<s.length;l++)try{t.push({expr:s[l].expr,fn:new Function("state","with(state){return ("+s[l].expr+");}")})}catch(e){t.push({expr:s[l].expr,fn:function(){return""}})}}if(U(r.c))for(var c=0;c<r.c.length;c++)e(r.c[c]);else Y(r.c,"object")&&r.c.t&&e(r.c)}}(e),function(r){var o=new V(e);if(o._compile=!0,o._precompiledBindings=t,r)for(var n in r)P.call(r,n)&&(o._state[n]=r[n]);return o}},B.css=function(e,t={}){const{minify:r=!1,pretty:o=!r}=t;if(Y(e,"string"))return e;let n="";const i=o?"  ":"",a=o?"\n":"",s=o?" ":"";return U(e)?n=e.map(e=>B.css(e,t)).join(a):Y(e,"object")&&Object.entries(e).forEach(([e,r])=>{if(Y(r,"object")){if("@"===e.charAt(0)){const o=B.css(r,t);return void(o&&(n+=`${e}${s}{${a}${o}${a}}${a}`))}const o=Object.entries(r).filter(([,e])=>null!=e).map(([e,t])=>{const r=e.replace(/[A-Z]/g,e=>"-"+e.toLowerCase());return`${i}${r}:${s}${t};`}).join(a);o&&(n+=`${e}${s}{${a}${o}${a}}${a}`)}}),n.trim()},B.injectCSS=function(e,t={}){if(!B._isBrowser)return W("bw.injectCSS requires a DOM environment"),null;const{id:r="bw_styles",append:o=!0}=t;let n=document.getElementById(r);n||(n=document.createElement("style"),n.id=r,n.type="text/css",document.head.appendChild(n));const i=Y(e,"string")?e:B.css(e,t);return o&&n.textContent?n.textContent+="\n"+i:n.textContent=i,n},B.s=function(){for(var e={},t=0;t<arguments.length;t++){var r=arguments[t];Y(r,"object")&&Object.assign(e,r)}return e},B.u={flex:{display:"flex"},flexCol:{display:"flex",flexDirection:"column"},flexRow:{display:"flex",flexDirection:"row"},flexWrap:{display:"flex",flexWrap:"wrap"},block:{display:"block"},inline:{display:"inline"},hidden:{display:"none"},justifyCenter:{justifyContent:"center"},justifyBetween:{justifyContent:"space-between"},justifyEnd:{justifyContent:"flex-end"},alignCenter:{alignItems:"center"},alignStart:{alignItems:"flex-start"},alignEnd:{alignItems:"flex-end"},gap1:{gap:"0.25rem"},gap2:{gap:"0.5rem"},gap3:{gap:"0.75rem"},gap4:{gap:"1rem"},gap6:{gap:"1.5rem"},gap8:{gap:"2rem"},p0:{padding:"0"},p1:{padding:"0.25rem"},p2:{padding:"0.5rem"},p3:{padding:"0.75rem"},p4:{padding:"1rem"},p6:{padding:"1.5rem"},p8:{padding:"2rem"},px4:{paddingLeft:"1rem",paddingRight:"1rem"},py2:{paddingTop:"0.5rem",paddingBottom:"0.5rem"},py4:{paddingTop:"1rem",paddingBottom:"1rem"},m0:{margin:"0"},m4:{margin:"1rem"},mt2:{marginTop:"0.5rem"},mt4:{marginTop:"1rem"},mb2:{marginBottom:"0.5rem"},mb4:{marginBottom:"1rem"},mx_auto:{marginLeft:"auto",marginRight:"auto"},textSm:{fontSize:"0.875rem"},textBase:{fontSize:"1rem"},textLg:{fontSize:"1.125rem"},textXl:{fontSize:"1.25rem"},text2xl:{fontSize:"1.5rem"},text3xl:{fontSize:"1.875rem"},bold:{fontWeight:"700"},semibold:{fontWeight:"600"},italic:{fontStyle:"italic"},textCenter:{textAlign:"center"},textRight:{textAlign:"right"},bgWhite:{background:"#ffffff"},bgTeal:{background:"#006666",color:"#ffffff"},textWhite:{color:"#ffffff"},textTeal:{color:"#006666"},textMuted:{color:"#888"},rounded:{borderRadius:"0.375rem"},roundedLg:{borderRadius:"0.5rem"},roundedFull:{borderRadius:"9999px"},border:{border:"1px solid #d8d8d8"},wFull:{width:"100%"},hFull:{height:"100%"},transition:{transition:"all 0.2s ease"}},B.responsive=function(e,t){var r={sm:"576px",md:"768px",lg:"992px",xl:"1200px"},o=[];return H(t).forEach(function(n){var i={};"base"===n?(i[e]=t[n],o.push(B.css(i))):r[n]&&(i[e]=t[n],o.push("@media (min-width: "+r[n]+") {\n"+B.css(i)+"\n}"))}),o.join("\n")},B.mapScale=I,B.clip=N,B._isBrowser&&(B.$=function(e){return e?U(e)?e:e.nodeType?[e]:void 0===e.length||Y(e,"string")?Y(e,"string")?Array.from(document.querySelectorAll(e)):[]:Array.from(e):[]},B.$.one=function(e){return B.$(e)[0]||null}),B.loadDefaultStyles=function(e={}){const{minify:t=!0,palette:r}=e;if(B._isBrowser){var o=B.css(A());B.injectCSS(o,{id:"bw_structural",append:!1,minify:t})}var n=Object.assign({},j,r||{});return B.generateTheme("",Object.assign({},n,{inject:!0}))},B.generateTheme=function(e,t){if(!t||!t.primary||!t.secondary)throw new Error("bw.generateTheme requires config.primary and config.secondary");var r=Object.assign({},j,t);t.tertiary||(r.tertiary=r.primary);var o=h(r),n=function(e){var t=e&&e.spacing||"normal",r=e&&e.radius||"md",o=e&&e.fontSize||1,n=e&&e.typeRatio||"normal",i="string"==typeof n?y[n]||y.normal:n,a=e&&e.elevation||"md",s=e&&e.motion||"standard";return{spacing:"string"==typeof t?g[t]||g.normal:t,radius:"string"==typeof r?v[r]||v.md:r,fontSize:o,typeScale:x(16,i),elevation:"string"==typeof a?k[a]||k.md:a,motion:"string"==typeof s?C[s]||C.standard:s}}(r),i=M(e,o,n),a=B.css(i),s=h(f(r)),l=function(e,t,r){var o=M("",t,r),n=e?"."+e+".bw_theme_alt":".bw_theme_alt",i={};for(var a in o)if(o.hasOwnProperty(a))if("@"===a.charAt(0)){var s=o[a],l={};for(var c in s)s.hasOwnProperty(c)&&(l[n+" "+c]=s[c]);i[a]=l}else{for(var d=a.split(","),b=[],_=0;_<d.length;_++){var p=d[_].trim();"body"===p||p.indexOf("body"),b.push(n+" "+p)}i[b.join(", ")]=o[a]}return i[n+" body, :root"+n+" body"]={color:t.dark.base,"background-color":t.light.base},i}
/**
 ...
 * @license BSD-2-Clause
 * @author M A Chatterjee <deftio [at] deftio [dot] com>
 */(e,s,n),c=B.css(l),d=u(r);if(!1!==t.inject&&B._isBrowser){var b=e?e.replace(/-/g,"_"):"",_=b?"bw_theme_"+b:"bw_theme_default",p=b?"bw_theme_"+b+"_alt":"bw_theme_default_alt";if(B.injectCSS(a,{id:_,append:!1}),B.injectCSS(c,{id:p,append:!1}),B._activeThemeStyleIds=[_,p],e){var m=document.body;B._activeThemeClass&&B._activeThemeClass!==e&&m.classList.remove(B._activeThemeClass),m.classList.add(e),B._activeThemeClass=e}}e||(B.u.bgTeal={background:o.primary.base,color:o.primary.textOn},B.u.textTeal={color:o.primary.base},B.u.bgWhite={background:"#ffffff"},B.u.textWhite={color:"#ffffff"});var w={css:a,palette:o,name:e,isLightPrimary:d,alternate:{css:c,palette:s}};return B._activeTheme=w,B._activeThemeMode="primary",w},B.applyTheme=function(e){if(!B._isBrowser)return e||"primary";var t,r=document.documentElement,o=!B._activeTheme||B._activeTheme.isLightPrimary;return(t="primary"!==e&&("alternate"===e||("light"===e?!o:"dark"===e&&o)))?r.classList.add("bw_theme_alt"):r.classList.remove("bw_theme_alt"),B._activeThemeMode=t?"alternate":"primary",B._activeThemeMode},B.toggleTheme=function(){var e=B._activeThemeMode||"primary";return B.applyTheme("primary"===e?"alternate":"primary")},B.clearTheme=function(){B._activeThemeStyleIds&&B._isBrowser&&(B._activeThemeStyleIds.forEach(function(e){var t=document.getElementById(e);t&&t.remove()}),B._activeThemeStyleIds=null),B._activeThemeClass&&B._isBrowser&&(document.body.classList.remove(B._activeThemeClass),B._activeThemeClass=null),B._activeTheme=null,B._activeThemeMode="primary"},B.hexToHsl=a,B.hslToHex=s,B.adjustLightness=l,B.mixColor=c,B.relativeLuminance=d,B.textOnColor=b,B.deriveShades=p,B.derivePalette=h,B.harmonize=_,B.deriveAlternateSeed=m,B.deriveAlternateConfig=f,B.isLightPalette=u,B.SPACING_PRESETS=g,B.RADIUS_PRESETS=v,B.TYPE_RATIO_PRESETS=y,B.ELEVATION_PRESETS=k,B.MOTION_PRESETS=C,B.generateTypeScale=x,B.DEFAULT_PALETTE_CONFIG=j,B.THEME_PRESETS=S,B.choice=function(e,t,r){const o=e in t?t[e]:r;return"function"===E(o)?o(e):o},B.arrayUniq=L,B.arrayBinA=function(e,t){return"array"!==E(e)||"array"!==E(t)?[]:L(e.filter(e=>-1!==t.indexOf(e)))},B.arrayBNotInA=function(e,t){return"array"!==E(e)||"array"!==E(t)?[]:L(t.filter(t=>e.indexOf(t)<0))},B.colorInterp=function(e,t,r,n,i){return function(e,t,r,o,n,i){let a=Array.isArray(o)?o:["#000","#fff"];if(a=0===a.length?["#000","#fff"]:a,1===a.length)return a[0];a=a.map(e=>i(e));const s=I(e,t,r,0,a.length-1,{clip:!0,expScale:n}),l=N(Math.floor(s),0,a.length-2),c=s-l,d=e=>I(c,0,1,a[l][e],a[l+1][e],{clip:!0});return[d(0),d(1),d(2),d(3),"rgb"]}(e,t,r,n,i,o)},B.colorHslToRgb=i,B.colorRgbToHsl=n,B.colorParse=o,B.setCookie=function(e,t,r,o={}){if(!B._isBrowser)return;const n=new Date;n.setTime(n.getTime()+24*r*60*60*1e3);let i=`${e}=${t}; expires=${n.toUTCString()}`;o.path&&(i+=`; path=${o.path}`),o.domain&&(i+=`; domain=${o.domain}`),o.secure&&(i+="; secure"),o.sameSite&&(i+=`; samesite=${o.sameSite}`),document.cookie=i},B.getCookie=function(e,t){if(!B._isBrowser)return t;const r=e+"=",o=document.cookie.split(";");for(let e=0;e<o.length;e++){let t=o[e];for(;" "===t.charAt(0);)t=t.substring(1);if(0===t.indexOf(r))return t.substring(r.length,t.length)}return t},B.getURLParam=function(e,t){if(!B._isBrowser||"object"!=typeof window)return t;try{const r=new URLSearchParams(window.location.search);if(!e){const e={};for(const[t,o]of r)e[t]=o||!0;return e}return r.has(e)?r.get(e)||!0:t}catch(e){return t}},B.loremIpsum=function(e,t,r=!0){const o="Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. ";"number"!=typeof e&&(e=Math.floor(125*Math.random())+25),void 0===t&&(t=Math.floor(446*Math.random())),t%=446;let n=0;for(;" "===o[t]||/[.,:;!?]/.test(o[t]);)if(t=(t+1)%446,n++,n>=446){t=0,n=0;break}let i=o.substring(t)+o.substring(0,t),a="",s=e+n;for(;s>0;)a+=s<i.length?i.substring(0,s):i,s-=i.length;if(a.length>e&&(a=a.substring(0,e))," "===a[a.length-1]&&(a=a.substring(0,a.length-1)+"."),r){let e=a[0].toUpperCase();e=/[A-Z]/.test(e)?e:"L",a=e+a.substring(1)}return a},B.multiArray=function(e,t){t="number"==typeof t?[t]:t;const r=o=>{if(o>=t.length)return"function"===E(e)?e():e;const n=[];for(let e=0;e<t[o];e++)n[e]=r(o+1);return n};return r(0)},B.naturalCompare=function(e,t){if(isFinite(e)&&isFinite(t))return Math.sign(e-t);const r=String(e).toLowerCase(),o=String(t).toLowerCase();if(r===o)return e>t?1:0;if(!/\d/.test(r)||!/\d/.test(o))return r>o?1:-1;const n=r.match(/(\d+|\D+)/g)||[],i=o.match(/(\d+|\D+)/g)||[],a=Math.min(n.length,i.length);for(let e=0;e<a;e++){const t=n[e],r=i[e];if(t!==r){if(/^\d+$/.test(t)&&/^\d+$/.test(r)){let e=t,o=r;return"0"===t[0]&&(e="0."+t),"0"===r[0]&&(o="0."+r),parseFloat(e)-parseFloat(o)}return t>r?1:-1}}return n.length-i.length},B.setIntervalX=function(e,t,r){let o=0;const n=setInterval(function(){e(o),++o>=r&&clearInterval(n)},t);return n},B.repeatUntil=function(e,t,r,o=250,n=10,i){if("function"!=typeof e)return"err";let a=0;const s=setInterval(function(){const o=e();a++,o?(clearInterval(s),t&&t(o),i&&i(!0,a)):a>=n?(clearInterval(s),r&&r(),i&&i(!1,a)):r&&r()},o);return s},function(e){e.saveClientFile=function(t,r){if(e.isNodeJS())e._getFs().then(function(e){e?e.writeFile(t,r,function(e){e&&console.error("Error saving file:",e)}):console.error("bw.saveClientFile: fs module not available")});else{var o=new Blob([r],{type:"application/octet-stream"}),n=window.URL.createObjectURL(o),i=e.createDOM({t:"a",a:{href:n,download:t,style:"display: none"}});document.body.appendChild(i),i.click(),window.URL.revokeObjectURL(n),document.body.removeChild(i)}},e.saveClientJSON=function(t,r){e.saveClientFile(t,JSON.stringify(r,null,2))},e.loadClientFile=function(t,r,o){var n={parser:"raw"};o&&o.parser&&(n.parser=o.parser);var i="JSON"===n.parser?JSON.parse:function(e){return e};if(e.isNodeJS())e._getFs().then(function(e){e?e.readFile(t,"utf8",function(e,t){if(e)r(null,e);else try{r(i(t),null)}catch(e){r(null,e)}}):r(null,new Error("fs module not available"))});else{var a=new XMLHttpRequest;a.open("GET",t,!0),a.onreadystatechange=function(){if(4===a.readyState)if(a.status>=200&&a.status<300)try{r(i(a.responseText),null)}catch(e){r(null,e)}else r(null,new Error("HTTP "+a.status+": "+t))},a.send(null)}return"BW_OK"},e.loadClientJSON=function(t,r){return e.loadClientFile(t,r,{parser:"JSON"})},e.loadLocalFile=function(t,r){var o={parser:"raw",accept:""};r&&(r.parser&&(o.parser=r.parser),r.accept&&(o.accept=r.accept));var n="JSON"===o.parser?JSON.parse:function(e){return e};if(e.isNodeJS())t(null,"",new Error("bw.loadLocalFile is browser-only. Use bw.loadClientFile() in Node."));else{var i=e.createDOM({t:"input",a:{type:"file",accept:o.accept,style:"display: none"}});i.addEventListener("change",function(){var e=i.files[0];if(e){var r=new FileReader;r.onload=function(r){try{t(n(r.target.result),e.name,null)}catch(r){t(null,e.name,r)}},r.onerror=function(){t(null,e.name,r.error)},r.readAsText(e),i.remove()}else t(null,"",new Error("No file selected"))}),document.body.appendChild(i),i.click()}},e.loadLocalJSON=function(t){e.loadLocalFile(t,{parser:"JSON",accept:".json"})}}(B),B.copyToClipboard=function(e){return navigator.clipboard&&navigator.clipboard.writeText?navigator.clipboard.writeText(e):new Promise((t,r)=>{const o=B.createDOM({t:"textarea",a:{value:e,style:{position:"fixed",top:"-999px",left:"-999px",width:"2em",height:"2em",padding:0,border:"none",outline:"none",boxShadow:"none",background:"transparent"}}});document.body.appendChild(o),o.focus(),o.select();try{const e=document.execCommand("copy");document.body.removeChild(o),e?t():r(new Error("Copy command failed"))}catch(e){document.body.removeChild(o),r(e)}})},B.makeTable=function(e){const{data:t=[],columns:r,className:o="",striped:n=!1,hover:i=!1,sortable:a=!0,onSort:s,sortColumn:l,sortDirection:c="asc",selectable:d=!1,onRowClick:b,pageSize:_,currentPage:p=1,onPageChange:m}=e;let u="bw_table";n&&(u+=" bw_table_striped"),(i||d)&&(u+=" bw_table_hover"),d&&(u+=" bw_table_selectable"),o&&(u+=" "+o),u=u.trim();const f=r||(t.length>0?H(t[0]).map(e=>({key:e,label:e})):[]);let h=l||null,w=c,g=[...t];h&&g.sort((e,t)=>{const r=e[h],o=t[h];if(Y(r,"number")&&Y(o,"number"))return"asc"===w?r-o:o-r;const n=String(r||"").toLowerCase(),i=String(o||"").toLowerCase();return"asc"===w?n.localeCompare(i):i.localeCompare(n)});const v=g.length,y=_?Math.max(1,Math.ceil(v/_)):1,x=Math.max(1,Math.min(p,y));if(_){const e=(x-1)*_;g=g.slice(e,e+_)}const k={t:"table",a:{class:u},c:[{t:"thead",c:{t:"tr",c:f.map(e=>({t:"th",a:a?{style:{cursor:"pointer",userSelect:"none"},onclick:()=>{return t=e.key,void(a&&(h===t?w="asc"===w?"desc":"asc":(h=t,w="asc"),s&&s(t,w)));var t}}:{},c:[e.label,a&&h===e.key&&{t:"span",a:{style:{marginLeft:"5px"}},c:"asc"===w?"▲":"▼"}].filter(Boolean)}))}},{t:"tbody",c:g.map((e,t)=>{const r=_?(x-1)*_+t:t,o={};return(d||b)&&(o.style="cursor:pointer;",o.onclick=function(t){d&&t.currentTarget.classList.toggle("bw_table_row_selected");b&&b(e,r,t)}),{t:"tr",a:o,c:f.map(t=>({t:"td",c:t.render?t.render(e[t.key],e):String(e[t.key]||"")}))}})}]};if(!_)return k;const C=[];return C.push({t:"button",a:{class:"bw_btn bw_btn_sm",disabled:x<=1?"disabled":void 0,onclick:x>1&&m?function(){m(x-1)}:void 0},c:"Prev"}),C.push({t:"span",a:{style:"margin:0 0.5rem;font-size:0.875rem;"},c:"Page "+x+" of "+y}),C.push({t:"button",a:{class:"bw_btn bw_btn_sm",disabled:x>=y?"disabled":void 0,onclick:x<y&&m?function(){m(x+1)}:void 0},c:"Next"}),{t:"div",a:{class:"bw_table_paginated"},c:[k,{t:"div",a:{class:"bw_table_pagination",style:"display:flex;align-items:center;justify-content:flex-end;padding:0.5rem 0;gap:0.25rem;"},c:C}]}},B.makeTableFromArray=function(e){const{data:t=[],headerRow:r=!0,columns:o,...n}=e;if(!U(t)||0===t.length)return B.makeTable({data:[],columns:o||[],...n});let i,a;if(r&&t.length>0)i=t[0].map(function(e){return String(e)}),a=t.slice(1);else{const e=t[0].length;i=[];for(let t=0;t<e;t++)i.push("col"+t);a=t}const s=a.map(function(e){const t={};return i.forEach(function(r,o){t[r]=void 0!==e[o]?e[o]:""}),t}),l=o||i.map(function(e){return{key:e,label:e}});return B.makeTable({data:s,columns:l,...n})},B.makeBarChart=function(e){const{data:t=[],labelKey:r="label",valueKey:o="value",title:n,color:i="#006666",height:a="200px",formatValue:s,showValues:l=!0,showLabels:c=!0,className:d=""}=e;if(!U(t)||0===t.length)return{t:"div",a:{class:("bw_bar_chart_container "+d).trim()},c:""};const b=t.map(function(e){return Number(e[o])||0}),_=Math.max.apply(null,b),p=t.map(function(e,t){const o=b[t],n=_>0?o/_*100:0,a=s?s(o):String(o),d=[];return l&&d.push({t:"div",a:{class:"bw_bar_value"},c:a}),d.push({t:"div",a:{class:"bw_bar",style:"height:"+n+"%;background:"+i+";"}}),c&&d.push({t:"div",a:{class:"bw_bar_label"},c:String(e[r]||"")}),{t:"div",a:{class:"bw_bar_group"},c:d}}),m=[];return n&&m.push({t:"h3",a:{class:"bw_bar_chart_title"},c:n}),m.push({t:"div",a:{class:"bw_bar_chart",style:"height:"+a+";"},c:p}),{t:"div",a:{class:("bw_bar_chart_container "+d).trim()},c:m}},B.makeDataTable=function(e){const{title:t,data:r,columns:o,className:n="",striped:i=!0,hover:a=!0,responsive:s=!0,...l}=e,c=B.makeTable({data:r,columns:o,className:n,striped:i,hover:a,...l}),d=[];return t&&d.push({t:"h5",a:{class:"mb-3"},c:t}),s?d.push({t:"div",a:{class:"table-responsive"},c:c}):d.push(c),{t:"div",a:{class:"table-container"},c:d}},B._componentRegistry=new Map,B.render=function(e,t,r){const o=Y(e,"string")?document.querySelector(e):e;if(!o)return{object_type:"error",component_id:null,object_handle_in_dom:null,status_code:"error=target_element_not_found"};const n=r.o?.id||B.uuid();let i;try{i=B.createDOM(r)}catch(e){return{object_type:"error",component_id:n,object_handle_in_dom:null,status_code:`error=render_failed:${e.message}`}}i.setAttribute("data-bw_id",n);try{switch(t){case"replace":o.parentNode.replaceChild(i,o);break;case"prepend":o.insertBefore(i,o.firstChild);break;case"append":o.appendChild(i);break;case"before":o.parentNode.insertBefore(i,o);break;case"after":o.parentNode.insertBefore(i,o.nextSibling);break;default:throw new Error(`Invalid position: ${t}`)}}catch(e){return{object_type:"error",component_id:n,object_handle_in_dom:null,status_code:`error=insertion_failed:${e.message}`}}const a={object_type:r.t||"element",component_id:n,object_handle_in_dom:i,status_code:"success",_taco:{...r},_state:{...r.o?.state||{}},_mounted:!0,get element(){return this.object_handle_in_dom},getState(){return{...this._state}},setState(e){return this._state={...this._state,...e},this._taco.o?.onStateChange&&this._taco.o.onStateChange(this._state,e),this},update(){if(!this._mounted||!this.element)return this;const e=this.element.parentNode;this._taco.o&&(this._taco.o.state=this._state);const t=B.createDOM(this._taco);return t.setAttribute("data-bw_id",n),e.replaceChild(t,this.element),this.object_handle_in_dom=t,this._taco.o?.onUpdate&&this._taco.o.onUpdate(t,this._state),this},getProp(e){return this._taco.a?.[e]},setProp(e,t){return this._taco.a||(this._taco.a={}),this._taco.a[e]=t,this.element&&(null==t?this.element.removeAttribute(e):!0===t?this.element.setAttribute(e,""):this.element.setAttribute(e,String(t))),this},getContent(){return this._taco.c},setContent(e){return this._taco.c=e,this.element&&(Y(e,"string")?this.element.textContent=e:this.update()),this},addClass(e){return this.element&&this.element.classList.add(e),this},removeClass(e){return this.element&&this.element.classList.remove(e),this},toggleClass(e){return this.element&&this.element.classList.toggle(e),this},hasClass(e){return!!this.element&&this.element.classList.contains(e)},show(){return this.element&&(this.element.style.display=""),this},hide(){return this.element&&(this.element.style.display="none"),this},on(e,t){return this.element&&this.element.addEventListener(e,t),this},off(e,t){return this.element&&this.element.removeEventListener(e,t),this},destroy(){return this._mounted?(this._taco.o?.unmount&&this._taco.o.unmount(this.element),this.element&&this.element.parentNode&&this.element.parentNode.removeChild(this.element),B._componentRegistry.delete(n),this._mounted=!1,this.object_handle_in_dom=null,this.status_code="destroyed",this):this}};return B._componentRegistry.set(n,a),r.o?.mounted&&r.o.mounted(i,a),a},B.getComponent=function(e){return B._componentRegistry.get(e)||null},B.getAllComponents=function(){return new Map(B._componentRegistry)},Object.entries(F).forEach(([e,t])=>{e.startsWith("make")&&(B[e]=t)}),B.make=R,B.BCCL=D,B.variantClass=$,Object.entries(F).forEach(([e,t])=>{if(e.startsWith("make")){const r="create"+e.substring(4);B[r]=function(e){const r=t(e);return B.renderComponent(r)}}}),B._isBrowser&&"undefined"!=typeof window&&(window.bw=B);export{B as default};

      ...
      c: [
        {
          ...
          c: 'Where do these styles come from?'
        },
        {
          t: 'div',
          ...
          c: [
            {
              t: 'p',
              c: [
                'The ', { t: 'code', c: 'bw-btn' }, ', ', { t: 'code', c: 'bw-card' },
                ', and other ', { t: 'code', c: 'bw-*' }, ' classes come from bitwrench\'s built-in CSS. You get them two ways:'
              ]
            },
            {
              t: 'ol',
              c: [
                {
                  t: 'li',
                  c: [
                    { t: 'code', c: '<link href="bitwrench.css">' },
                    ' \u2014 pre-built CSS file, include like Bootstrap'
                  ]
                },
                {
                  t: 'li',
                  c: [
                    { t: 'code', c: 'bw.loadDefaultStyles()' },
                    ' \u2014 generate from JS objects at runtime (no CSS file needed)'
                  ]
                }
              ]
            },
